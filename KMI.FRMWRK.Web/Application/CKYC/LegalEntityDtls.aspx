<%@ Page Title="" Language="C#" MasterPageFile="~/Empty.Master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeBehind="LegalEntityDtls.aspx.cs" Inherits="KMI.FRMWRK.Web.Application.CKYC.LegalEntityDtls" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function validatePAN(obj) {
            ...
            var reg = /^[A-Z]{3}[PCFT]{1}[A-Z]{1}[0-9]{4}[A-Z]{1}$/
        ...
        function fnValidateEntityPAN(Obj) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="EmptyPagePlaceholder" runat="server">
    <script type="text/javascript">
       ...
       <%-- function OpenStateWindow2(Flag1) {
        ...
        function OpenPartialEntRelatedPersonPageEditNew(RelRefnNo, refno, drNo) {
            debugger;
            var modal = document.getElementById('myModalRaise');
            var modaliframe = document.getElementById("iframeCFR");

            modaliframe.src = "CKYCEntAsRelPerson.aspx?Status=PMod&Action=Edit&refno=" + refno + "&relrefno=" + RelRefnNo + "&drNo=" + drNo;
            $('#myModalRaise').modal('show');
        }
        ...
        function OpenControllingPersonPageViewNew(RelRefnNo, refno) {
            ...
            modaliframe.src = "CKYCControllingPrsn.aspx?Status=View&refno=" + refno + "&relrefno=" + RelRefnNo;
            $('#myModalRaise1').modal('show');
        }
        ...
        <ContentTemplate>
            <div class="container" style="margin-top: 0px; width: 100%;">
                <div class="panel panel-success" style="margin-left: 0px; margin-right: 0px">
                    ...
                    <div id="divCKYCdtls" style="display: block;" class="panel-body">
                        <div class="row" style="margin-bottom: 5px">
                            ...
                            <div class="col-sm-3" style="text-align: left">
                                <asp:TextBox ID="txtRefNumber" runat="server" MaxLength="14" CssClass="form-control" OnTextChanged="txtRefNumber_TextChanged"
                                    AutoPostBack="true" onChange="javascript:this.value=this.value.toUpperCase();"
                        ...
                        <div class="row" style="margin-bottom: 5px">
                            ...
                            <div class="col-sm-3" style="text-align: left">
                                <asp:DropDownList ID="ddlNatureOfBuss" AutoPostBack="true" OnSelectedIndexChanged="ddlNatureOfBuss_SelectedIndexChanged" runat="server" CssClass="form-control" TabIndex="2">
                                    <%--<asp:ListItem Value="02" Text="02"></asp:ListItem>--%>
                                </asp:DropDownList>
                            </div>
                            <div class="col-sm-3" style="text-align: left">
                                <asp:Label ID="Label1" Text="Constitution Type others" runat="server" Font-Bold="false">
                                </asp:Label>
                                <span style="color: red">*</span>
                            </div>
                            <div class="col-sm-3" style="text-align: left">
                                <asp:TextBox ID="txtConstitutionTypeothers" runat="server" MaxLength="200" CssClass="form-control" Font-Bold="false"
                                    TabIndex="2" />
                            </div>
                        </div>
                    </div>
                ...
                <div class="panel panel-success" style="margin-left: 0px; margin-right: 0px;">
                    ...
                    <div id="divDetailOfEntity" class="panel-body">
                    ...
                    <div class="col-sm-3" style="text-align: left; top: 0px; left: 0px;">
                        ...
                        <div class="row" style="margin-bottom: 5px">
                            ...
                            <div class="col-sm-3" style="text-align: left; top: 0px; left: 0px;">
                                <asp:TextBox ID="txtPanNo" runat="server" AutoPostBack="true" OnTextChanged="txtPanNo_TextChanged" MaxLength="10" CssClass="form-control"
                            ...
                            <div class="col-sm-3">
                                <asp:CheckBox ID="chkPanForm" Text="FORM 60" OnCheckedChanged="chkPanForm_CheckedChanged" Enabled="true"
                        ...
                        <div class="row" style="margin-bottom: 5px">
                            <div class="col-sm-3" style="text-align: left">
                                <asp:Label ID="lblTypeIdentiNo" Text="TIN/GST Registration number" runat="server"
                                    Font-Bold="false"></asp:Label>
                                <%--<span style="color: red">*</span>--%>
                            </div>
                            <div class="col-sm-3" style="text-align: left; top: 0px; left: 0px;">
                ...
                <div class="panel panel-success" style="margin-left: 0px; margin-right: 0px">
                    <div id="Div6" runat="server" class="panel-heading subheader" onclick="showHideDiv('div7','Span2');return false;">
                        <div class="row">
                            <div class="col-sm-10" style="text-align: left">
                                <span class="glyphicon glyphicon-menu-hamburger"></span>
                    ...
                    <div id="div7" style="display: block;" class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <asp:DropDownList ID="ddlProofOfAddress" runat="server" CssClass="form-control" Enabled="false" AutoPostBack="true"
                                    OnSelectedIndexChanged="ddlProofOfAddress_SelectedIndexChanged" TabIndex="2">
                        ...
                        <div id="divAddProof" runat="server" class="row" visible="false">
                            ...
                            <div id="divPassNotxtAdd" runat="server" class="col-sm-3">
                                <asp:TextBox CssClass="form-control" runat="server" onChange="javascript:this.value=this.value.toUpperCase();"
                                    ID="txtPassNoAdd" Enabled="false" MaxLength="15" TabIndex="2" />
                            ...
                            <div id="divPassDateAdd" runat="server" class="col-sm-3">
                                <asp:TextBox CssClass="form-control" onmousedown="$('#EmptyPagePlaceholder_txtPassExpDateAdd').datepicker({ changeMonth: true, changeYear: true, dateFormat: 'dd/mm/yy' });"
                                    runat="server"
                                    ID="txtPassExpDateAdd" MaxLength="15" TabIndex="2" Enabled="false" />
                        ...
                        <div class="row" style="margin-top: 4px">
                            ...
                            <div class="col-sm-3">
                                <asp:TextBox ID="txtCity" runat="server" CssClass="form-control" Enabled="false" onkeypress="fncInputcharacterOnlyNew();" TabIndex="2" MaxLength="50">
                                </asp:TextBox>
                            </div>
                        </div>
                        <div class="row" style="margin-top: 4px">
                            ...
                            <div class="col-sm-3">
                                <div id="dvState" runat="server" class="input-group">
                                    <asp:DropDownList ID="ddlState" runat="server" Enabled="false" CssClass="form-control" TabIndex="2">
                                        <asp:ListItem Value="" Text="Select"></asp:ListItem>
                                    </asp:DropDownList>
                                    <asp:HiddenField runat="server" ID="hdnddlPinCode" />
                                    <div class="input-group-btn">
                                        <asp:LinkButton runat="server" ID="LinkButton2" CssClass="btn btn-primary btn-lg-kmi" title="Search" data-toggle="tooltip"
                                            OnClick="GetModelData" TabIndex="2">
                            ...
                            <div class="col-sm-3">
                                ...
                                <asp:UpdatePanel runat="server">
                                    <ContentTemplate>
                                        <asp:TextBox ID="txtPinCode" MaxLength="10" onkeypress="fncInputNumericValuesOnly();" runat="server" Enabled="false"
                        ...
                        <div class="row" style="margin-top: 4px">
                            ...
                            <div class="col-sm-3">
                                <asp:UpdatePanel runat="server">
                                    <ContentTemplate>
                                        <asp:TextBox runat="server" ID="txtDistrictname" Enabled="false" CssClass="form-control"></asp:TextBox>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </div>
                            <div class="col-sm-3" style="text-align: left">
                            ...
                            <div class="col-sm-3">
                                <asp:UpdatePanel runat="server">
                                    <ContentTemplate>
                                        <asp:DropDownList ID="ddlCountryCode" runat="server" Enabled="false" AutoPostBack="true" CssClass="form-control" OnSelectedIndexChanged="ddlCountryCode_SelectedIndexChanged"
                                            TabIndex="2">
                                            <asp:ListItem Value="" Text="Select"></asp:ListItem>
                                        </asp:DropDownList>
                                    </ContentTemplate>
                        ...
                        <div style="margin-top: 25px; margin-bottom: 25px">
                            <div class="row">
                                <div class="col-sm-12" style="text-align: left">
                                    <asp:CheckBox ID="chkLocalAddress" Text="CORRESPONDENCE / LOCAL ADDRESS DETAILS" runat="server" AutoPostBack="true"
                                        OnCheckedChanged="chkLocalAddress_CheckedChanged"
                                        CssClass="standardcheckbox" TabIndex="2" />
                                    <span style="color: red">*</span>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12" style="text-align: left">
                                    ...
                                    <asp:CheckBox ID="chkCuurentAddress" Text="Same as Current / Permanent / Overseas Address details"
                                        OnCheckedChanged="chkCuurentAddress_Checked" AutoPostBack="true" runat="server" Enabled="false"
                                        CssClass="standardcheckbox" TabIndex="2" />
                                    <%--<span style="color: red">*</span>--%>
                                </div>
                            </div>
                            <div class="row" style="margin-top: 4px">
                                ...
                                <%--<div class="col-sm-3" style="text-align: left">
                                        ...
                                        <div class="col-sm-3">
                                            <asp:DropDownList ID="ddlProofOfAddress1" runat="server" CssClass="form-control" Enabled="false"
                                                TabIndex="2">
                                                <asp:ListItem Value="" Text="Select"></asp:ListItem>
                                            </asp:DropDownList>
                                        </div>--%>
                            ...
                            <div class="row" style="margin-top: 4px">
                                ...
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtCity1" runat="server" onkeypress="fncInputcharacterOnlyNew();" Enabled="false"
                                        CssClass="form-control" TabIndex="2" MaxLength="50"></asp:TextBox>
                                </div>
                            </div>
                            <div class="row" style="margin-top: 4px">
                                <div class="col-sm-3" style="text-align: left">
                                ...
                                <div class="col-sm-3">
                                    <div id="dvState1" runat="server" class="input-group">
                                        <asp:DropDownList ID="ddlState1" runat="server" Enabled="false" CssClass="form-control" TabIndex="2">
                                            <asp:ListItem Value="" Text="Select"></asp:ListItem>
                                        </asp:DropDownList>
                                        <asp:HiddenField runat="server" ID="hdnddlPinCode1" />
                                        <div class="input-group-btn">
                                            <asp:LinkButton runat="server" ID="btnsearchddlPinCode1" CssClass="btn btn-primary btn-lg-kmi" title="Search" data-toggle="tooltip"
                                                OnClick="GetModelData1" TabIndex="2">
                                            <span class="glyphicon glyphicon-search BtnGlyphicon"></span>
                                            </asp:LinkButton>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="">
                                        <asp:UpdatePanel runat="server">
                                            <ContentTemplate>
                                                <asp:TextBox ID="ddlPinCode1" MaxLength="10" Enabled="false" onkeypress="fncInputNumericValuesOnly();" runat="server" CssClass="form-control" TabIndex="2"></asp:TextBox>
                            ...
                            <div class="row" style="margin-top: 4px">
                                ...
                                <div class="col-sm-3">
                                    <asp:UpdatePanel runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox runat="server" ID="txtDistrict1" Enabled="false" CssClass="form-control"></asp:TextBox>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                                <div class="col-sm-3" style="text-align: left">
                                ...
                                <div class="col-sm-3">
                                    <asp:DropDownList ID="ddlCountryCode1" runat="server" Enabled="false" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlCountryCode1_SelectedIndexChanged"
                                        TabIndex="2">
                                        <asp:ListItem Value="" Text="Select"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                ...
                <div class="panel panel-success" style="margin-left: 0px; margin-right: 0px">
                    <div id="Div4" runat="server" class="panel-heading subheader"
                        onclick="showHideDiv('div9','Span3');return false;">
                        <div class="row">
                            <div class="col-sm-10" style="text-align: left">
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    <span class="input-group-addon input-group-addon-tel" style="width: 23% !important; border-top-left-radius: 7% !important; padding: 0px !important; border: 0px !important;">
                                        <asp:TextBox ID="txtTelOff" runat="server" CssClass="form-control" MaxLength="4" TabIndex="2"
                                            Style="border-top-left-radius: 4px; border-bottom-left-radius: 4px;" onkeypress="fncInputNumericValuesOnly();"></asp:TextBox>
                                    </span>
                                    <asp:TextBox ID="txtTelOff2" runat="server" CssClass="form-control" onblur="fnValidateNumber(this.id,'8');" onkeypress="fncInputNumericValuesOnly();" TabIndex="2"
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    ...
                                    <asp:TextBox ID="txtTelRes2" runat="server" CssClass="form-control" MaxLength="10"
                                        onkeypress="fncInputNumericValuesOnly();" onblur="fnValidateNumber(this.id,'8');" TabIndex="2"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row" style="margin-top: 4px">
                            ...
                            <div class="col-sm-3" style="text-align: left">
                                <asp:Label ID="Label2" runat="server" Text="Mobile Number 2" CssClass="control-label"></asp:Label>
                            </div>
                            <div class="col-sm-3">
                                <div class="input-group">
                                    <span class="input-group-addon " style="width: 23% !important; border-top-left-radius: 7% !important; padding: 0px !important; border: 0px !important;">
                    ...
                    <div id="menu4" style="display: block;" class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div id="div5" class="col-sm-3" style="text-align: left" runat="server">
                                <asp:LinkButton ID="lnkViewRel" runat="server" Text="View Related Person Detail" ForeColor="Black" FontBold="true" OnClick="lnkViewRel_Click" TabIndex="2">
                                </asp:LinkButton>
                            </div>
                        </div>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Relative Name" ItemStyle-Width="20%" SortExpression="Candidate Name">
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lblNameVal" runat="server" Text='<%# (Eval("FNameRel") + "" + Eval("LNameRel")) != "" ? (Eval("FNameRel") + " " + Eval("LNameRel")) : Eval("RelEntName") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle CssClass="pad" HorizontalAlign="Center" Width="10%" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:LinkButton ID="lnkEdit" runat="server" OnClick="lnkEdit_Click" Text="Edit" ForeColor="Black" CommandArgument='<%# Eval("RelRefNo") %>'></asp:LinkButton>&nbsp;
                            ...
                            <div id="div16" style="display: block;" class="panel-body">
                                <div class="row">
                                    <div class="col-sm-12" style="text-align: left; display: flex;">
                                        <asp:CheckBox Style="margin-bottom: -0.5%;" ID="chkAppDeclare1" Text="I hereby declare that the details furnished above are true and correct to the best of my knowledge and belief and I undertake to inform you of"
                                    ...
                                    <div class="col-sm-12" style="text-align: left; display: flex; font-weight: bold; padding-left: 2.5%;">
                                        <asp:Label CssClass="control-label" Text="any changes therein, immediately.In case any of the above information is found to be false or untrue or misleading or misrepresenting, I am aware that I may be held liable for it."
                        ...
                        <div class="panel panel-success" style="margin-left: 0px; margin-right: 0px">
                            ...
                            <div class="col-sm-3" style="text-align: left; top: 0px; left: 0px;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <asp:TextBox CssClass="form-control" runat="server" ID="txtInsCode" MaxLength="7" onkeypress="funIsAlphaNumericWithoutSpace();"
                                            Enabled="true" TabIndex="2" />
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <asp:UpdatePanel runat="server" UpdateMode="Conditional" RenderMode="Inline">
                                <ContentTemplate>
                                    <iframe id="iframeCFR" src="" width="100%" height="380" style="margin-top: 1%;" frameborder="0" allowtransparency="true"></iframe>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" id="btnSubmitRelType" onclick="GetCallRelatedPerson()" class="btn btn-primary">Submit</button>
                        </div>
                    </div>
                </div>
            </div>
