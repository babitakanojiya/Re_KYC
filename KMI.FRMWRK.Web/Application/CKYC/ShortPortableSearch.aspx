<%@ Page Title="" Language="C#" MasterPageFile="~/Empty.Master" AutoEventWireup="true" CodeBehind="ShortPortableSearch.aspx.cs" Inherits="KMI.FRMWRK.Web.Application.CKYC.ShortPortableSearch" %>
    ...
    <div class="page-container" style="margin-top: 0px;">
        <div id="trDgViewDtl" runat="server" class="page-container" style="margin-top: 0px;">
            ...
            <div class="panel panel-success" style="margin-left: 2%; margin-right: 2%; margin-top: 0.5%">
                <div id="Div1"  class="panel-heading" style='margin-left: 0px; margin-right: 0px;'
                    onclick="showHideDiv('trgridsponsorship','Span4');return false;">
                    <div class="row" id="Div2" runat="server">
                      <div class="col-sm-10" style="text-align: left">
                            <span class="glyphicon glyphicon-menu-hamburger"></span>
                            <asp:Label ID="Label1" runat="server" Text="Probable Match Based on Partial Data (Search API)"></asp:Label>
                        </div>
                         <div class="col-sm-2">
                ...
                <asp:GridView ID="dgView" runat="server" CssClass="footable" 
                    AutoGenerateColumns="true" PageSize="10" CellPadding="1" Style="border-collapse: collapse; width: 1271px;">
