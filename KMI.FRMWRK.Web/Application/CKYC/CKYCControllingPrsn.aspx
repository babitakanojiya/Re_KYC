<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Empty.Master" MaintainScrollPositionOnPostback="true" CodeBehind="CKYCControllingPrsn.aspx.cs" Inherits="KMI.FRMWRK.Web.Application.CKYC.CKYCControllingPrsn" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="EmptyPagePlaceholder" runat="server">
    ...
    <script type="text/javascript">
        ...
        function fnValidateMobile() {
            debugger;
            var Mobile1 = document.getElementById("EmptyPagePlaceholder_txtMobile2").value;
            if (Mobile1 != "") {

                if (Mobile1.length != 10) {
                    AlertMsg("Mobile No. should be 10 digit");
                    document.getElementById("EmptyPagePlaceholder_txtMobile2").value = "";
                    document.getElementById("EmptyPagePlaceholder_txtMobile2").focus();
                    return false;
                }

                if (Mobile1.substr(0, 1) == "0" || Mobile1.substr(0, 1) == "1" || Mobile1.substr(0, 1) == "2" || Mobile1.substr(0, 1) == "3"
                                 || Mobile1.substr(0, 1) == "4" || Mobile1.substr(0, 1) == "5") {
                    AlertMsg("Mobile No. should start with (6,7,8,9)");
                    document.getElementById("EmptyPagePlaceholder_txtMobile2").value = "";
                    document.getElementById("EmptyPagePlaceholder_txtMobile2").focus();
                    return false;
        ...
        function tinvalidation(Obj) {                                       //Function added by daksh-- Validation
            ...
            if (Obj.value != "") {
                ...
                if (panPat.test(Obj.value)) {
                    ...
                    //document.getElementById("spntincnt").style.display = "none";
                    //document.getElementById("dvTINCntry").style.display = "none";
                    AlertMsg("Please enter valid TIN number");
                    Obj.value = "";
                    Obj.focus();
                    return false;
                }
        ...
        <div class="panel panel-success" style="margin-left: 0px; margin-right: 0px">
            ...
            <div id="divCKYCdtls" style="display: block;" class="panel-body">
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <asp:TextBox CssClass="form-control" runat="server" AutoPostBack="true" ID="txtKYCNum" OnTextChanged="txtKYCNum_TextChanged" onkeypress="funIsAlphaNumericWithoutSpace();"
                            placeholder="KYC Number" MaxLength="14" TabIndex="2" />
                        <%--OnTextChanged="txtKYCNumber_TextChanged" AutoPostBack="true" --%>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-3" style="text-align: left">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <asp:DropDownList ID="ddlTrust" runat="server" CssClass="form-control" TabIndex="2">
                            <asp:ListItem Value="" Text="Select"></asp:ListItem>
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="row" style="margin-top: 4px">
                    ...
                    <div class="col-sm-3">
                        <asp:DropDownList ID="ddlOthrLglArrange" runat="server" CssClass="form-control" TabIndex="2">
                            <asp:ListItem Value="" Text="Select"></asp:ListItem>
                        </asp:DropDownList>
                    </div>
    ...
    <%--Img section End--%>
                        ...
                        <div class="panel panel-success" style="margin-left: 0px; margin-right: 0px">
                                        ...
                                        <div class="row" style="margin-top: 4px">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="input-group">
                                                    <asp:TextBox ID="txtDOB" runat="server" placeholder="dd-mm-yyyy" CssClass="form-control" onchange="ValidateDOB(this.value);" MaxLength="10" TabIndex="2"></asp:TextBox>
                                            ...
                                            <%--<div class="col-sm-3" style="text-align: left">
                                                <asp:Label ID="lbldob" Text="DOB" runat="server" CssClass="control-label">   
                                                </asp:Label>
                                                <span style="color: red">*</span>
                                            </div>
                                            <div class="col-sm-3">
                                                 <asp:TextBox CssClass="form-control"
                                                    onmousedown="$('#EmptyPagePlaceholder_txtDOB').datepicker({ changeMonth: true,maxDate : new Date(), changeYear: true, dateFormat: 'dd-mm-yy', yearRange: '1945:'+(new Date).getFullYear()});"
                                                    runat="server" ID="txtDOB" MaxLength="15" onchange="ValidateDOB(this.value);" autocomplete="off"
                                                    TabIndex="2" />
                                            </div>--%>
                                        ...
                                        <div class="row" style="margin-top: 4px">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <asp:UpdatePanel ID="upIsoCountryCodeOthr" runat="server">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlIsoCountryCodeOthr" runat="server" CssClass="form-control" AutoPostBack="true" TabIndex="2" Visible="false"></asp:DropDownList>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                            ...
                            <div class="col-sm-3">
                                    ...
                                    tabindex="12" enabled="true" />--%>
                                                <asp:DropDownList ID="ddlIsoCountryCode2" runat="server" CssClass="form-control" TabIndex="2"></asp:DropDownList>
                                            ...
                                            <div class="col-sm-3">
                                                <asp:TextBox CssClass="form-control" placeholder="TIN Number" onkeypress="fncInputNumericValuesWithHyphenOnly();" onblur="tinvalidation(this);"
                                                    runat="server" ID="txtIDResTax" MaxLength="11"
                                                    TabIndex="2" />
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top: 3px">
                                            ...
                                            <div class="col-sm-3">
                                                <asp:TextBox CssClass="form-control" placeholder="Place / City of Birth" onkeypress="fncInputcharacterOnlyNew();"
                                                    runat="server" ID="txtDOBRes" MaxLength="20"
                                                    TabIndex="2" />
                                            </div>
                                            <div class="col-sm-3" style="text-align: left">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <asp:DropDownList ID="ddlIsoCountry" runat="server" CssClass="form-control" TabIndex="2"></asp:DropDownList>
                                ...
                                <%--<div class="panel panel-success" style="margin-left: 0px; margin-right: 0px">
                                 ...
                                 <asp:CheckBox ID="chkTick" Text="RESIDENCE FOR TAX PURPOSES IN JURISDICTION(S) OUTSIDE INDIA" 
                                               style="display: none !important;" Checked="true"  CssClass="standardcheckbox" runat="server" TabIndex="31" />    <%--AutoPostBack="true" OnCheckedChanged="chkTick_Checked"--%>
                        ...
                        <div id="divIdProof" runat="server" class="row">
                            ...
                            <div id="divPassNotxt" runat="server" class="col-sm-3">
                                <asp:TextBox CssClass="form-control" runat="server"
                                    onChange="javascript:this.value=this.value.toUpperCase();" ID="txtPassNo" MaxLength="15" TabIndex="2" />
                            ...
                            <div id="divPassDate" class="col-sm-3">
                                ...
                                <asp:TextBox CssClass="form-control" runat="server" onkeypress="fncInputDocsKeyValidate();" ID="txtPassOthr" MaxLength="15" TabIndex="2" />
                            </div>
                                    ...
                                    <div id="div7" style="display: block;" class="panel-body">
                                        <div class="row">
                                            <div class="col-sm-12" style="text-align: left">
                                                <asp:CheckBox ID="chkPerAddress" Text="CURRENT / PERMANENT / OVERSEAS ADDRESS DETAILS" AutoPostBack="true" OnCheckedChanged="chkPerAddress_Checked"
                                                    runat="server" CssClass="standardcheckbox" Enabled="false" Checked="true" TabIndex="2" />
                                                <span style="color: red">*</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3">
                                                <asp:DropDownList ID="ddlProofOfAddress" runat="server" CssClass="form-control" AutoPostBack="true" 
                                                    TabIndex="2"><%--OnSelectedIndexChanged="ddlProofOfAddress_SelectedIndexChanged"--%>
                                                    <asp:ListItem Value="" Text="Select"></asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <div id="divAddProof" runat="server" class="row" style="margin-top: 4px">
                                            ...
                                            <div id="divPassNotxtAdd" runat="server" class="col-sm-3">
                                                <asp:TextBox CssClass="form-control" runat="server"
                                                    onChange="javascript:this.value=this.value.toUpperCase();" ID="txtPassNoAdd" MaxLength="15" TabIndex="2" />
                                            ...
                                            <div id="divPassDateAdd" class="col-sm-3">
                                                <div class="input-group">
                                                    ...
                                                    <div id="hidetxtPassExpDateAdd" runat="server" class="input-group-btn">
                                                        <div class="btn btn-primary btn-lg-kmi" onclick="callCalender4()">
                                                            <span class="glyphicon glyphicon-calendar BtnGlyphicon"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div id="divPassDateAdd" runat="server" class="col-sm-3">
                                                ...
                                                <asp:TextBox CssClass="form-control" onmousedown="$('#EmptyPagePlaceholder_txtPassExpDateAdd').datepicker({ changeMonth: true, changeYear: true, dateFormat: 'dd-mm-yy' });"
                                                    runat="server" ID="txtPassExpDateAdd" MaxLength="15" TabIndex="2" />
                                        ...
                                        <div class="row" style="margin-top: 4px">
                                            ...
                                            <div class="col-sm-3">
                                                <asp:TextBox CssClass="form-control" onchange="setDateFormat('txtDrivLicNum')" runat="server"
                                                    placeholder="Line 1" ID="txtAddressLine1" MaxLength="300" TabIndex="2" />
                                            </div>
                                            <div class="col-sm-3" style="text-align: left">
                                            ...
                                            <div class="col-sm-3">
                                                <asp:TextBox CssClass="form-control" onchange="setDateFormat('txtAddressLine2')"
                                                    runat="server" placeholder="Line 2" ID="txtAddressLine2" MaxLength="300" TabIndex="2" />
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top: 4px">
                                            <div class="col-sm-3" style="text-align: left">
                                        ...
                                        <div class="row" style="margin-top: 4px">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <asp:TextBox ID="txtPinCode" placeholder="Pin / Post Code" runat="server" MaxLength="10" onkeypress="fncInputNumericValuesOnly();" CssClass="form-control" TabIndex="2"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top: 4px">
                                            ...
                                            <div class="col-sm-3">
                                                <asp:TextBox runat="server" ID="txtDistrictname" CssClass="form-control" TabIndex="2"></asp:TextBox>
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <asp:DropDownList ID="ddlCountryCode" runat="server" CssClass="form-control" AutoPostBack="true" TabIndex="2" OnSelectedIndexChanged="ddlCountryCode_SelectedIndexChanged"></asp:DropDownList>
                                            </div>
                                        </div>
                                        ...
                                        <div style="margin-top: 25px; margin-bottom: 25px">
                                            ...
                                            <div class="row" style="margin-top: 4px">
                                                ...
                                                <div class="col-sm-3">
                                                    <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlAddressType1" runat="server" CssClass="form-control" 
                                                                TabIndex="2">
                                                                <asp:ListItem Value="" Text="Select"></asp:ListItem>
                                                            </asp:DropDownList>
                                                        </ContentTemplate>
                                            ...
                                            <div class="row" style="margin-top: 4px">
                                                ...
                                                <div class="col-sm-3">
                                                    <asp:TextBox ID="txtCity1" runat="server" CssClass="form-control" TabIndex="2" onkeypress="fncInputcharacterOnlyNew();" MaxLength="50"></asp:TextBox>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row" style="margin-top: 4px">
                                            ...
                                            <div class="col-sm-3">
                                                <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlAddressType2" runat="server" CssClass="form-control" 
                                                            TabIndex="2">
                                                            <asp:ListItem Value="" Text="Select"></asp:ListItem>
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                        ...
                                        <div class="row" style="margin-top: 4px">
                                            ...
                                            <div class="col-sm-3">
                                                <asp:TextBox ID="txtCity2" runat="server" CssClass="form-control" TabIndex="2" onkeypress="fncInputcharacterOnlyNew();" MaxLength="50"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top: 4px">
                                    ...
                                    <div id="div9" style="display: block;" class="panel-body">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon input-group-addon-tel" style="width: 23% !important; border-top-left-radius: 7% !important; padding: 0px !important; border: 0px !important;">
                                                        <asp:TextBox ID="txtTelOff" runat="server" CssClass="form-control" MaxLength="2" onblur="fnValidateCode(this.id,'2');" onkeypress="fncInputNumericValuesOnly();" TabIndex="2"></asp:TextBox>
                                                    </span>
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-addon input-group-addon-tel" style="width: 23% !important; border-top-left-radius: 7% !important; padding: 0px !important; border: 0px !important;">
                                                        <asp:TextBox ID="txtTelRes" runat="server" CssClass="form-control" TabIndex="2"
                                                            onkeypress="fncInputNumericValuesOnly();" MaxLength="2" onblur="fnValidateCode(this.id,'2');" Style="border-top-left-radius: 4px; border-bottom-left-radius: 4px; top: 0px; left: 0px;"></asp:TextBox>
                                                    </span>
                                                    <asp:TextBox ID="txtTelRes2" runat="server" CssClass="form-control" MaxLength="8" onblur="fnValidateNumber(this.id,'8');"
                                        ...
                                        <div class="row" style="margin-top: 4px">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon " style="width: 23% !important; border-top-left-radius: 7% !important; padding: 0px !important; border: 0px !important;">
                                                        <asp:TextBox ID="TextBox21" runat="server" CssClass="form-control" onkeypress="fncInputNumericValuesOnly();"
                                                            MaxLength="2" onblur="fnValidateCode(this.id,'2');" Style="border-top-left-radius: 4px; border-bottom-left-radius: 4px;" TabIndex="2"></asp:TextBox>
                                                    </span>
                                                    <asp:TextBox ID="TextBox22" runat="server" CssClass="form-control" onkeypress="fncInputNumericValuesOnly();" onblur="fnValidateMobile();"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon input-group-addon-tel" style="width: 23% !important; border-top-left-radius: 7% !important; padding: 0px !important; border: 0px !important;">
                                                        <asp:TextBox ID="txtFax1" runat="server" onkeypress="fncInputNumericValuesOnly();" MaxLength="2" onblur="fnValidateCode(this.id,'2');" CssClass="form-control" TabIndex="2"></asp:TextBox>
                                                    </span>
                                                    <asp:TextBox ID="txtFax2" runat="server" CssClass="form-control" MaxLength="8" onblur="fnValidateNumber(this.id,'8');" onkeypress="fncInputNumericValuesOnly();" TabIndex="2"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top: 4px">
                            ...
                            <br />--%>
                                <div class="row">
                                    ...
                                    <div class="col-sm-3" style="text-align: left; top: 0px; left: 0px;">
                                        <asp:TextBox ID="txtDate" runat="server" CssClass="form-control" MaxLength="10" onmousedown="$(this).datepicker({ maxDate: new Date() ,changeMonth: true, changeYear: true, dateFormat: 'dd-mm-yy' })" TabIndex="2"></asp:TextBox>
                                    </div>--%>
                        ...
                        <div class="panel panel-success" style="margin-left: 0px; margin-right: 0px">
                            ...
                            <div id="div17" style="display: block;" class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="input-group">
                                            <asp:TextBox ID="txtDate3" runat="server" placeholder="dd-mm-yyyy" CssClass="form-control" MaxLength="10" TabIndex="2"></asp:TextBox>
                                            <div class="input-group-btn">
                                                <%--<asp:LinkButton runat="server" ID="LinkButton3" CssClass="btn btn-primary btn-lg-kmi"   onmousedown="checkDateOfIncorp(this);" title="Date" data-toggle="tooltip"  TabIndex="2">--%>
                                    ...
                                    <div class="col-sm-3" style="text-align: left; top: 0px; left: 0px;">
                                        <asp:TextBox ID="txtDate3" runat="server" CssClass="form-control" MaxLength="10" onmousedown="$(this).datepicker({ maxDate: new Date() ,changeMonth: true, changeYear: true, dateFormat: 'dd-mm-yy' })" TabIndex="2"></asp:TextBox>
                                    </div>--%>
                                </div>
                                <div class="row" style="margin-top: 17px">
                                    ...
                                    <div class="col-sm-3">
                                        <asp:TextBox CssClass="form-control" placeholder="Employee Name" runat="server" ID="txtEmpName" MaxLength="50"
                                            Enabled="true" TabIndex="2" onkeypress="fncInputValidateName();" />
                                        <br />
                                    </div>
                                    <div class="col-sm-3" style="text-align: left">
                                        <asp:Label ID="lblEmpCode" Text="Employee Code" runat="server" CssClass="control-label">
                                    ...
                                    <div class="col-sm-3">
                                        <asp:TextBox CssClass="form-control" placeholder="Employee Code" runat="server" ID="txtEmpCode" MaxLength="20" onkeypress="funIsAlphaNumericWithoutSpace();" 
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <asp:TextBox CssClass="form-control" runat="server" placeholder="Employee Designation" ID="txtEmpDesignation" MaxLength="50" 
                                            onkeypress="fncInputValidateDesignation();"  Enabled="true" TabIndex="2" />
                                    </div>
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <asp:TextBox CssClass="form-control" runat="server" placeholder="Employee Branch" onkeypress="fncInputcharacterOnlyNew();" ID="txtEmpBranch" MaxLength="50"
                                            Enabled="true" TabIndex="2" />
                                    </div>
                                </div>
                                <br />
                                ...
                                <div class="row" style="0px">
                                    ...
                                    <div class="col-sm-3">
                                        <asp:TextBox CssClass="form-control" runat="server" onkeypress="funIsAlphaNumericWithoutSpace();" placeholder="Institution Code" ID="txtInsCode" MaxLength="6"
                                            Enabled="true" TabIndex="2" />
                                    </div>
                                </div>
                            </div>
        ...
        <div class="row" style="margin-top: 12px;">
            <div class="col-sm-12" align="center">
                <%-- <asp:linkbutton id="btnUpdate" text="UPDATE" runat="server" cssclass="btn btn-primary"
                ...
                <%--<asp:LinkButton ID="btnSave" OnClientClick="return funCKYC();" OnClick="btnSave_Click"
                 ...
                 <asp:LinkButton ID="btnPSUpdate" runat="server" cssclass="btn-animated bg-green" Visible="false" onclick="btnPSUpdate_Click" > 
                     <span class="glyphicon glyphicon-floppy-disk BtnGlyphicon"></span> Partial Update </asp:LinkButton>

                <asp:LinkButton ID="btnUpdate" runat="server" cssclass="btn-animated bg-green" Visible="false" onclick="btnUpdate_Click" > 
                    <span class="glyphicon glyphicon-floppy-disk BtnGlyphicon"></span> Update </asp:LinkButton>
