...
{
    public partial class CKYCControllingPrsn : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    else if (Request.QueryString["Status"].ToString() == "View")
                    {
                        ...
                        ddlCitizenship_SelectedIndexChanged(this, EventArgs.Empty);
                        //FillCtrlPersonPartialdata();
                        FillCtrlPersonViewdata();
            ...
            try
            {
                ...
                if (ddlProofOfAddress.SelectedIndex != 0)
                {
                    ...
                    if (ddlProofOfAddress.SelectedIndex == 3)
                    {
                        if (txtPassNoAdd.Text == "")
                        {
                            ScriptManager.RegisterStartupScript(this, this.GetType(), "alertmsg", "AlertMsg('Please enter UID(aadhaar)')", true);
                            txtPinCode.Text = "";
                            return;
                        }
                    }
        ...
        private void PopulatePinCode()
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    objErr = new ErrorLog();
                    objErr.LogErr(AppID, "CKYCRelatedPrsn.aspx.cs", "PopulatePinCode", ex.InnerException == null ? ex.Message.ToString() : ex.Message.ToString() + " | " + ex.InnerException.ToString(), strUserId, "CKYC");
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alertmsg", "AlertMsg('Something went wrong, Kindly contact to service provider.');", true);
                }
            }
            finally
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string Res;
                    Res = objVal.EntityControlPrsnValidation(ddlRelType, cboTitle, txtGivenName, txtLastName, cboTitle2, rbtFS,
                    txtGivenName2, txtLastName2, cboTitle3, txtGivenName3, txtLastName3, txtDOB, cboGender, ddlOccupation, ddlOccuSubType,
                    ddlMaritalStatus, ddlCitizenship, ddlResStatus, ddlIsoCountryCodeOthr, chkTick, ddlIsoCountryCode2,
                    txtIDResTax, txtDOBRes, ddlIsoCountry, ddlProofIdentity, txtPassNo, txtPassExpDate, txtPassOthr, ddlAddressType,
                    chkPerAddress, chkAppDeclare1, ddlProofOfAddress, txtAddressLine1, txtCity, txtPinCode, txtDate3,
                    txtEmpName, txtEmpCode, txtEmpDesignation, txtEmpBranch, txtInsName, txtInsCode, txtDate, txtPassExpDateAdd, txtPassNoAdd, chkAppDeclare2, txtPlace,
                    ddlDocReceived, ddlState, chkDone, txtPassOthrAdd,
                    chkLocalAddress, ddlAddressType1, txtLocAddLine1, txtCity1, ddlState1,
                    ddlPinCode1, ddlCountryCode1,
                    chkAddResident, ddlAddressType2, txtAddLine1, txtCity2, ddlState2, ddlPinCode2, ddlIsoCountryCode);   //chkTick, chkHigh, chkMedium, chkLow,
                    if (Res.Equals(""))
                    {
                        if (txtDOB.Text != "")
                        {
                        ...
                        //DtAdd = (DataTable)Session["dsCtrl"];
                        ...
                        dataRow["RelationType"] = ddlRelType.SelectedValue.Trim();
                        ...
                        dataRow["OccuTypeRel"] = ddlOccupation.SelectedValue.Trim();
                        ...
                        if (chkPerAddress.Checked == true)
                        {
                            ...
                            dataRow["AdrTypeRel"] = ddlAddressType.SelectedValue.Trim();
                        ...
                        if (chkAddResident.Checked == true)
                        {
                            ...
                            dataRow["AdrTypeRel2"] = ddlAddressType2.SelectedValue.Trim();
                            //dataRow["AdrProfRel1"] = ddlProofOfAddress.SelectedValue;
                            ...
                            {
                                //htParam.Add("@PER_STATECODE", txtState.Text.Trim());
                                dataRow["StateCodeRel2"] = txtState2.Text.Trim();
                            }
                        ...
                        dataRow["OccuSubTypeRel"] = ddlOccuSubType.SelectedValue;

                        dataRow["TelSTDCode"] = txtTelOff.Text.Trim();
                        dataRow["TelNo"] = txtTelOff2.Text.Trim();
                        dataRow["OfficeTelSTDCode"] = txtTelRes.Text.Trim();
                        dataRow["OfficeTelNo"] = txtTelRes2.Text.Trim();
                        dataRow["MobCode"] = TextBox21.Text.Trim();
                        dataRow["MobileNo"] = TextBox22.Text.Trim();
                        dataRow["FaxNoCode"] = txtFax1.Text.Trim();
                        dataRow["FaxNo"] = txtFax2.Text.Trim();
                        dataRow["EMAILID"] = txtemail.Text.Trim();
                        ...
                        Session["dsCtrl"] = DtAdd;
                        lblMsgConfirmYesNo.Text = "Controlling Details added successfully....Do you want to add more?.";
                        ClearTextcntrl();
                ...
                #region KYC 14 DIGIT SAVE FUNCTIONALITY start
                //KYC 14 DIGIT SAVE FUNCTIONALITY
                else
                {
                    string Res1;
                    Res1 = objVal.ControlPrsnValidationAccorKYC(ddlRelType, cboTitle, txtGivenName, txtLastName, cboTitle2, rbtFS,
                    txtGivenName2, txtLastName2, cboTitle3, txtGivenName3, txtLastName3, txtDOB, cboGender, ddlOccupation, ddlOccuSubType,
                    ddlMaritalStatus, ddlCitizenship, ddlResStatus, ddlIsoCountryCodeOthr, chkTick, ddlIsoCountryCode2,
                    txtIDResTax, txtDOBRes, ddlIsoCountry, ddlProofIdentity, txtPassNo, txtPassExpDate, txtPassOthr, ddlAddressType,
                    chkPerAddress, chkAppDeclare1, ddlProofOfAddress, txtAddressLine1, txtCity, txtPinCode, txtDate3,
                ...
                #endregion KYC 14 DIGIT SAVE FUNCTIONALITY END
                //KYC 14 Digit Functionality SAVE End
            }
            catch (Exception ex)
            {
                if (Session["UserID"].ToString().Trim() == null || Session["UserID"].ToString().Trim() == "")
        ...
        protected void disablecntrl()
        {
            try
            {
                ...
                ddlTrust.Enabled = false;
                ddlOthrLglArrange.Enabled = false;
        ...
        public void SetDataTable()
        {
            try
            {
                ...
                DtAdd.Columns.Add("TelSTDCode");
                DtAdd.Columns.Add("TelNo");
                DtAdd.Columns.Add("OfficeTelSTDCode");
                DtAdd.Columns.Add("OfficeTelNo");
                DtAdd.Columns.Add("MobCode");
                DtAdd.Columns.Add("MobileNo");
                DtAdd.Columns.Add("FaxNoCode");
                DtAdd.Columns.Add("FaxNo");
        ...
        protected void ClearTextcntrl()
        {
            try
            {
                ...
                txtKYCNum.Enabled = true;
                ddlTrust.SelectedIndex = 0;
                ddlOthrLglArrange.SelectedIndex = 0;
        ...
        protected void ShowOnGridView()
        {
            ...
            //else
            //{
            //    dataRow["ResForTaxFlagRel"] = "02";   //Commented as cheTick is not in Controlling Person
            //}
        ...
        protected void FillRelatedPersondata()
        {
            try
            {
                ...
                ddlIsoCountryCode2.SelectedValue = Convert.ToString(dt.Rows[0]["ResForTaxFlagRel"]);
        ...
        protected void btnPartialAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Res.Equals(""))
                {
                    ...
                    //dsRel1.Tables.Add(DtAdd);
                    Session["dsCtrl"] = DtAdd;
                    lblMsgConfirmYesNo.Text = "Controlling Details Partially added successfully....Do you want to add more?.";
                    ClearTextcntrl();
                    ClientScript.RegisterStartupScript(this.GetType(), "alert", "AsyncConfirmYesNo();", true);
        ...
        #region METHOD "FillRelatedPersondata"
        protected void FillCtrlPersonPartialdata()
        {
            try
            {
                ...
                dtNew = (DataTable)Session["dsCtrl"];
                ...
                if (Request.QueryString["RelRefNo"].ToString().Trim() == "0")
                {
                    ...
                    if (ddlOccupation.SelectedIndex != 0)
                    {
                        ...
                        ddlOccuSubType.SelectedValue = Convert.ToString(dtNew.Rows[idr]["OccuSubTypeRel"]);
                    }
                    else
                    {
                        FillSubOccuType(ddlOccupation, ddlOccuSubType);
                    ...
                    txtTelOff.Text = Convert.ToString(dtNew.Rows[idr]["TelSTDCode"]);
                    txtTelOff2.Text = Convert.ToString(dtNew.Rows[idr]["TelNo"]);
                    txtTelRes.Text = Convert.ToString(dtNew.Rows[idr]["OfficeTelSTDCode"]);
                    txtTelRes2.Text = Convert.ToString(dtNew.Rows[idr]["OfficeTelNo"]);
                    TextBox21.Text = Convert.ToString(dtNew.Rows[idr]["MobCode"]);
                    TextBox22.Text = Convert.ToString(dtNew.Rows[idr]["MobileNo"]);
                    txtFax1.Text = Convert.ToString(dtNew.Rows[idr]["FaxNoCode"]);
                    txtFax2.Text = Convert.ToString(dtNew.Rows[idr]["FaxNo"]);
                    txtemail.Text = Convert.ToString(dtNew.Rows[idr]["EMAILID"]);
                ...
                else
                {
                    ...
                    txtTelOff.Text = Convert.ToString(dt.Rows[0]["TelSTDCode"]);
                    txtTelOff2.Text = Convert.ToString(dt.Rows[0]["TelNo"]);
                    txtTelRes.Text = Convert.ToString(dt.Rows[0]["OfficeTelSTDCode"]);
                    txtTelRes2.Text = Convert.ToString(dt.Rows[0]["OfficeTelNo"]);
                    TextBox21.Text = Convert.ToString(dt.Rows[0]["MobCode"]);
                    TextBox22.Text = Convert.ToString(dt.Rows[0]["MobileNo"]);
                    txtFax1.Text = Convert.ToString(dt.Rows[0]["FaxNoCode"]);
                    txtFax2.Text = Convert.ToString(dt.Rows[0]["FaxNo"]);
            ...
            catch (Exception ex)
            {
                ...
                {
                    objErr = new ErrorLog();
                    objErr.LogErr(AppID, "CKYCRelatedPrsn.aspx.cs", "FillCtrlPersonPartialdata", ex.InnerException == null ? ex.Message.ToString() : ex.Message.ToString() + " | " + ex.InnerException.ToString(), strUserId, "CKYC");
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alertmsg", "AlertMsg('Something went wrong, Kindly contact to service provider.');", true);
                }
            }
        }
        ...
        #region METHOD "FillControllingPersonDataForView"
        protected void FillCtrlPersonViewdata()
        {
            try
            {
                objDAL = new DataAccessLayer("CKYCConnectionString");
                ...
                if (Request.QueryString["RelRefNo"].ToString().Trim() == "0")
                {
                    ...
                    ddlAddressType2.SelectedValue = Convert.ToString(dtNew.Rows[idr]["AdrTypeRel2"].ToString().Trim());
                    txtAddLine1.Text = Convert.ToString(dtNew.Rows[idr]["Adr1Rel2"]);
                    txtAddLine2.Text = Convert.ToString(dtNew.Rows[idr]["Adr2Rel2"]);
                    txtAddLine3.Text = Convert.ToString(dtNew.Rows[idr]["Adr3Rel2"]);
                    txtCity2.Text = Convert.ToString(dtNew.Rows[idr]["CityRel2"]);
        ...
        {
            htParam.Clear();
            htParam.Add("@LookupCode", "KEntCntrlTTType");
            FillDropdowns("prc_getDDLLookUpData", htParam, ddlRelType, "CKYCConnectionString", true);

            htParam.Clear();
            htParam.Add("@LookupCode", "KEntCntrlLPType");
            FillDropdowns("prc_getDDLLookUpData", htParam, ddlTrust, "CKYCConnectionString", true);

            htParam.Clear();
            htParam.Add("@LookupCode", "KEntCntrlLAType");
            FillDropdowns("prc_getDDLLookUpData", htParam, ddlOthrLglArrange, "CKYCConnectionString", true);
        }
        ...
        protected void FillddlPageLoad1()
        {
            //htParam.Clear();
        ...
        protected void btnPSUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Res.Equals(""))
                {
                    ...
                    DtAdd.Rows[idr]["OccuTypeRel"] = ddlOccupation.SelectedValue.Trim();
                    ...
                    if (chkPerAddress.Checked == true)
                    {
                        ...
                        DtAdd.Rows[idr]["AdrTypeRel"] = ddlAddressType.SelectedValue.Trim();
                    ...
                    if (chkLocalAddress.Checked == true)
                    {
                        ...
                        DtAdd.Rows[idr]["AdrTypeRel1"] = ddlAddressType1.SelectedValue.Trim();
                        //dataRow["AdrProfRel1"] = ddlProofOfAddress.SelectedValue;
                    ...
                    if (chkAddResident.Checked == true)
                    {
                        ...
                        DtAdd.Rows[idr]["AdrTypeRel2"] = ddlAddressType2.SelectedValue.Trim();
                        //dataRow["AdrProfRel1"] = ddlProofOfAddress.SelectedValue;
                        ...
                        {
                            //htParam.Add("@PER_STATECODE", txtState.Text.Trim());
                            DtAdd.Rows[idr]["StateCodeRel2"] = txtState2.Text.Trim();
                        }
                    ...
                    DtAdd.Rows[idr]["OccuSubTypeRel"] = ddlOccuSubType.SelectedValue;

                    DtAdd.Rows[idr]["TelSTDCode"] = txtTelOff.Text.Trim();
                    DtAdd.Rows[idr]["TelNo"] = txtTelOff2.Text.Trim();
                    DtAdd.Rows[idr]["OfficeTelSTDCode"] = txtTelRes.Text.Trim();
                    DtAdd.Rows[idr]["OfficeTelNo"] = txtTelRes2.Text.Trim();
                    DtAdd.Rows[idr]["MobCode"] = TextBox21.Text.Trim();
                    DtAdd.Rows[idr]["MobileNo"] = TextBox22.Text.Trim();
                    DtAdd.Rows[idr]["FaxNoCode"] = txtFax1.Text.Trim();
                    DtAdd.Rows[idr]["FaxNo"] = txtFax2.Text.Trim();
                    DtAdd.Rows[idr]["EMAILID"] = txtemail.Text.Trim();
                    ...
                    //dsRel1.Tables.Add(DtAdd);
                    Session["dsCtrl"] = DtAdd;
                    lblMsgConfirmYesNo.Text = "Controlling Details Partially updated successfully....Do you want to add more?.";
                    ClearTextcntrl();
                    ClientScript.RegisterStartupScript(this.GetType(), "alert", "AsyncConfirmYesNo();", true);
            ...
            try
            {
                if (txtKYCNum.Text.Trim().Length != 14)
                {
                    ...
                    if (Res.Equals(""))
                    {
                        ...
                        //dsRel1.Tables.Add(DtAdd);
                        Session["dsCtrl"] = DtAdd;
                        lblMsgConfirmYesNo.Text = "Controlling Details updated successfully....Do you want to add more?.";
                        ClearTextcntrl();
                        ClientScript.RegisterStartupScript(this.GetType(), "alert", "AsyncConfirmYesNo();", true);
                ...
                else
                {
                   ...
                   ddlProofIdentity, txtPassNo, txtPassExpDate, txtPassOthr,
                    ...
                    ddlDocReceived, ddlState, txtPassOthrAdd,txtCity);//chkHigh, chkMedium, chkLow,
