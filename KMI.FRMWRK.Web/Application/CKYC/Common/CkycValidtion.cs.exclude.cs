...
namespace KMI.FRMWRK.Web.Application.CKYC.Common
{
    public class CkycValidtion
    {
        ...
        public string Validation(CheckBox chkNormal, CheckBox chkSimplified, CheckBox Chksmall, DropDownList cboTitle, TextBox txtGivenName, TextBox txtLastName, RadioButtonList rbtFS, DropDownList cboTitle2, TextBox txtGivenName2, TextBox txtLastName2,
            DropDownList cboTitle3, TextBox txtGivenName3, TextBox txtLastName3, TextBox txtDOB, DropDownList cboGender, DropDownList ddlMaritalStatus, DropDownList ddlCitizenship,
            DropDownList ddlResStatus, DropDownList ddlOccupation, DropDownList ddlOccuSubType, CheckBox chkTick, DropDownList ddlIsoCountryCode2, TextBox txtIDResTax, TextBox txtDOBRes, DropDownList ddlIsoCountryRes,
            DropDownList ddlProofIdentity, TextBox txtPassNo, TextBox txtPassExpDate, CheckBox chkPerAddress, DropDownList ddlAddressType, DropDownList ddlProofOfAddress,
            ...
            CheckBox chkAddResident, TextBox txtAddLine1, TextBox txtCity2, DropDownList ddlIsoCountryCode, CheckBox chkAppDeclare1, TextBox txtDate, TextBox txtPlace,
            ...
            DropDownList ddlIsoCountry, TextBox txtPassOthr)
        {
            ...
            try
            {
                ...
                //added by ramesh on dated 25-05-2018
                ...
                if (ddlCitizenship.SelectedIndex == 2)
                {
                    ...
                    {
                        msg = "Please check in a check-box of jurisdiction detail";
                        return msg;
                    }
                    if (txtAddLine1.Text == "")
                    {
                ...
                if (txtPlace.Text == "")
                {
                    msg = "Please enter application declaration name";
                    return msg;
                }
        ...
        public string PersonalDtlsValidation(CheckBox chkNormal, CheckBox chkSimplified, CheckBox Chksmall, DropDownList cboTitle, TextBox txtGivenName, TextBox txtLastName,
            ...
            TextBox txtDOB, DropDownList cboGender, DropDownList ddlOccupation, DropDownList ddlOccuSubType, DropDownList ddlMaritalStatus, DropDownList ddlCitizenship,
            DropDownList ddlResStatus, DropDownList ddlIsoCountryCodeOthr, DropDownList ddlRelType, string flag)
        {
            string msg = string.Empty;
            string date;
            date = DateTime.Today.ToString("dd\\/MM\\/yyyy");
        ...
        public string LegalEntityDtlsValidation(CheckBox chkUSReport, CheckBox chkOtherReport, DropDownList ddlAccHolderType, DropDownList ddlNatureOfBuss, TextBox txtRefNumber, TextBox txtKYCName, TextBox txtDatOfInc,TextBox txtDtOfCom,
           ...
           DropDownList ddlAddressType1, TextBox txtLocAddLine1, TextBox txtCity1,
            ...
            DropDownList ddlState2, TextBox ddlPinCode2, TextBox txtDistrict2, DropDownList ddlIsoCountryCode) /*CheckBox chkCurrentAdd, */
        {
            string msg = string.Empty;
            string date;
            date = DateTime.Today.ToString("dd\\-MM\\-yyyy");
