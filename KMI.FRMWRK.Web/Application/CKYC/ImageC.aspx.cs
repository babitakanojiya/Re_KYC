...
{
    public partial class ImageC : System.Web.UI.Page
    {
        #region Declaration
        DataTable dt;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Request.QueryString["ImageID"] != null)
            {
                ...
                hTable.Add("@kycno", Request.QueryString["kycno"]);
                dt = dataAccessLayer.GetDataTable("prc_GetImagesbinaryForDNWL", hTable);
