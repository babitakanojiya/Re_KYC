...
<asp:Content ID="Content2" ContentPlaceHolderID="EmptyPagePlaceholder" runat="server">
    ...
    <script type="text/javascript">
        ...
        function OpenIdentityCodeMasterPage() {
            ...
            LoadingPagInPopUp("IdentityCodeMaster.aspx?CustType=01&Status=reg&CrS=" + "CF", "");
        ...
        function OpenProofofAddressMaster() {
            ...
            //var modaliframe = document.getElementById("iframeCFR_Master");
            //modaliframe.src = "../../Application/CKYC/CommunicationLog_NEW.aspx?refno=" + refno;
            LoadingPagInPopUp("ProofofAddressMaster.aspx?CustType=01&Status=reg&CrS=" + "CF", "");
    ...
    <script type="text/javascript">
        ...
        function getHeaderbyID(Code) {
            ...
            $.ajax({
                type: "POST",
                url: "CKYCIndReg.aspx/getHeaderbyIDMethod",
                ...
                <div class="panel panel-success" style="margin-left: 0px; margin-right: 0px">
                    ...
                    <div id="divCKYCdtls" style="display: block;" class="panel-body">
                        ...
                        <div class="row" style="margin-bottom: 5px">
                            <div class="col-sm-3" style="text-align: left">
                                <asp:Label ID="lblNatureOfBuss" Text="Nature of Business / Entity Constitution Type " runat="server" Font-Bold="false" Visible="false">
                                </asp:Label>
...
<div class="col-sm-3" style="text-align: left; display:flex">
    ...
    <div id="ddlAccountTypeLoader"></div>
                            ...
                            <div class="row">
                                <div class="col-sm-3" style="text-align: left">
                                    <asp:Label ID="Label7" Text="Residential Status" runat="server" CssClass="control-label">
                                    </asp:Label>
                                    <span style="color: red">*</span>
                                </div>
                                <div class="col-sm-3">
                ...
                <div class="panel panel-success" style="margin-left: 0px; margin-right: 0px">
                    ...
                    <%--Added by tushar For Master Detail Data Show--%>
                    <div style="padding-top: 10px">
                        <div id="div24" class="col-sm-3" style="text-align: left" runat="server">
                        </div>
                        <div id="div26" class="col-sm-3" style="text-align: left" runat="server">
                        </div>
                        <div id="div27" class="col-sm-3" style="text-align: left" runat="server">
                            <%-- <asp:LinkButton ID="lnkIdentityCodeMaster" runat="server" Text="View Identity Master" ForeColor="#99ccff"
                                FontBold="true" OnClientClick="OpenIdentityCodeMasterPage();"></asp:LinkButton>--%>
                            <asp:Label ID="lnkIdentityCodeMaster" runat="server" Visible="false" Text="View Identity Master" ForeColor="#99ccff" CssClass="pointer"
                        ...
                        <div id="divMster" class="col-sm-3" style="text-align: left" runat="server">
                            <%-- <asp:LinkButton ID="lnkProofofAddressMaster" runat="server" Text="View Address Master" ForeColor="#99ccff"
                                FontBold="true" OnClientClick="OpenProofofAddressMaster();"></asp:LinkButton>--%>
                            <asp:Label ID="lnkProofofAddressMaster" runat="server" Visible="false" Text="View Address Master" ForeColor="#99ccff" CssClass="pointer"
                                FontBold="true" onclick="OpenProofofAddressMaster();"></asp:Label>
                        </div>
                    </div>
                    <%--Ended by tushar For Master Detail Data Show--%>
                    <div id="menu2" style="display: block;" class="panel-body">
                        ...
                        <div class="row" style="display: none;">
                            ...
                            <div class="col-sm-3" style="display:flex;">
                                <asp:DropDownList ID="ddlProofIdentity" runat="server" CssClass="form-control" AutoPostBack="true"
                                   onChange="javascript:AddLoader('ddlProofIdentityLoader');" OnSelectedIndexChanged="ddlProofIdentity_SelectedIndexChanged" TabIndex="2">
                                </asp:DropDownList>
                                <div id="ddlProofIdentityLoader"></div>
                            </div>
                            <div class="col-sm-3">
                                <img src="../../assets/images/View_Identity_Master_sm.png" style="padding-right: 25px;" class="pointer" onclick="OpenIdentityCodeMasterPage();" />
                                <img src="../../assets/images/View_Address_Master_sm.png" class="pointer" onclick="OpenProofofAddressMaster();" />
                                <div visible="false" id="DivChkPOIFlag" runat="server">
                                    <asp:CheckBox Text="Is the Proof of Identity Document " ID="chkPOIFlag" runat="server" />
                                </div>
                            </div>
                        ...
                        <div id="div13" runat="server" class="row">
                            ...
                            <div class="container" style="padding-right: 46px;">
                                <asp:GridView ID="GridView1" runat="server" Width="100%" CssClass="footable" OnDataBinding="GridView1_DataBinding">
                                    ...
                                    <Columns>
                                        <asp:TemplateField><%--HeaderText="POI Document" >--%>
                                            <ItemTemplate>
                        ...
                        <%--<div class="col-sm-3" style="text-align: left">
                            ...
                            <div class="col-sm-3">
                                <asp:DropDownList ID="ddlProofOfAddress" runat="server" CssClass="form-control" AutoPostBack="true" Enabled="false"
                        ...
                        <%--<div id="divAddProof" runat="server" class="row">
                            ...
                            <div id="divPassNotxtAdd" runat="server" class="col-sm-3">
                                <asp:TextBox CssClass="form-control" runat="server" onChange="javascript:this.value=this.value.toUpperCase();"
                                    ID="txtPassNoAdd" MaxLength="40" TabIndex="43" />
                        ...
                        <div style="margin-top: 25px; margin-bottom: 25px">
                            <div class="row">
                                <div class="col-sm-12" style="text-align: left">
                                    ...
                                    <span style="color: red">*</span>--%>
                                    <asp:Label ID="Label4" Text="CURRENT ADDRESS DETAILS" runat="server" CssClass="control-label" Style="font-weight: 700;"></asp:Label>
                                    <span style="color: red">*</span>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row" style="display:none">
                                ...
                                <div class="col-sm-3" style="display:flex;">
                                    <asp:DropDownList ID="ddlProofOfAddress1" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlProofOfAddress1_SelectedIndexChanged"
                                        CssClass="form-control" onChange="javascript:AddLoader('ddlProofOfAddress1Loader');" 
                                        TabIndex="2">
                                        <asp:ListItem Value="" Text="Select"></asp:ListItem>
                                    </asp:DropDownList>
                ...
                <div class="panel panel-success" style="margin-left: 0px; margin-right: 0px">
                    ...
                    <div id="div9" style="display: block;" class="panel-body">
                        ...
                        <%--Added By Shubham--%>
                        <div id="divFax" runat="server" visible="false" class="row" style="margin-top: 4px">
                            <div class="col-sm-3" style="text-align: left">
            ...
            <div class="modal" id="myModalRaiseMst" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="padding-top: 0px;">
                <div class="modal-dialog" style="padding-top: 0px; margin-top: 2px; width: 60%;">
                    <div class="modal-content">
                        <div class="modal-header" style="margin-top: -10px; margin-bottom: -20px; padding-bottom: 6px ! important;">
                            ...
                            <h4 class="modal-title" id="myModalLabelMst">CKYC QC</h4>
                        </div>
                        <div class="modal-body">
