<%@ Page Title="" Language="C#" MasterPageFile="~/Empty.Master" AutoEventWireup="true" CodeBehind="CKYCView.aspx.cs" Inherits="KMI.FRMWRK.Web.Application.CKYC.CKYCView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="EmptyPagePlaceholder" runat="server">
   ...
   comment End--%>
    ...
    <script type="text/javascript">
        ...
        function callCalender() {
            debugger;
            var dateArr = $("#<%=txtDOB1.ClientID%>").val().split('-');
            $("#<%= txtDOB1.ClientID%>").datepicker({ maxDate: new Date(), changeMonth: true, changeYear: true, dateFormat: 'dd-mm-yy' });
        ...
        function SetMandorty(ID) {
            debugger;
            var ds = new Ajax.Web.DataSet();

            ds = Application_PSSNEW_SearchClientQCAmyGB.GetMandatorySpanId(ID);

            for (var i = 0; i < ds.value.Tables[0].Rows.length; i++) {
                document.getEmenu3lementById(ds.value.Tables[0].Rows[i]["TextboxName"].toString()).disabled = false;
            }
        }
    ...
    <div class="container" style="margin-top: 0px;">
        ...
        <div class="panel panel-success">
            ...
            <div id="divCKYCdtls" class="panel-body">
                <div class="row">
                    ...
                    <div class="col-sm-3" style="text-align: left">
                        <asp:CheckBox ID="cbNew" runat="server" CssClass="standardcheckbox" Text="&nbsp;&nbsp;Update" AutoPostBack="true"
                            Enabled="false" TabIndex="20" Visible="false" />
                        <asp:CheckBox ID="cbUpdate" runat="server" CssClass="standardcheckbox" Text="Update"
                            AutoPostBack="true" Visible="false" TabIndex="1" />
                         <asp:Label ID="Label2" runat="server" Text="Update" Font-Bold="true"></asp:Label>
                    </div>
                    <div class="col-sm-3" style="text-align: left">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3" style="text-align: left; display: none">
                        ...
                        <asp:CheckBox ID="Chksmall" runat="server" CssClass="standardcheckbox" Text="Small"
                            AutoPostBack="true" TabIndex="5" name="cb3" value="value1" />
                    </div>
                    ...
                    <div class="col-sm-3" style="text-align: left">
                        ...
                        <asp:DropDownList ID="ddlAccountType" runat="server" CssClass="form-control" TabIndex="2" ClientIDMode="Static">
                            ...
                            <asp:ListItem Value="2" Text="Simplified"></asp:ListItem>
                            <asp:ListItem Value="3" Text="Small"></asp:ListItem>
                        </asp:DropDownList>
                        <%--Added by tushar for--%>
                    </div>
        ...
        <asp:UpdatePanel ID="Updatepanel3" runat="server">
            <ContentTemplate>
                ...
                <div class="panel panel-success" id="menu1" style="margin-left: 0px; margin-right: 0px">
                    <div id="Div2" runat="server" class="panel-heading subheader" style="height: 47px; padding-top: 14px;">
                        <div class="row">
                            <div class="col-sm-3" style="text-align: left">
                                <span class="glyphicon glyphicon-menu-hamburger"></span>
                            ...
                            <div class="col-sm-3" style="text-align: right">
                                <asp:CheckBox ID="checkAppNameDtlupdFlag" Text="&nbsp;&nbsp;UPDATE APPLICANT NAME"
                                    CssClass="control-label" runat="server" AutoPostBack="true" OnCheckedChanged="checkAppNameDtlupdFlag_CheckedChanged"
                                    TabIndex="31" />
                            </div>
                            <div class="col-sm-3" style="text-align: right">
                                <asp:CheckBox ID="checkPersonalDtlupdFlag" Text="&nbsp;&nbsp;UPDATE PERSONAL DETAILS"
                                    CssClass="control-label" runat="server" AutoPostBack="true" OnCheckedChanged="checkPersonalDtlupdFlag_CheckedChanged"
                                    TabIndex="31" />
                            </div>
                            <div class="col-sm-1" onclick="showHideDiv('divPersonal','btnpersnl');return false;">
                    ...
                    <%--Added by tushar for Update Detail--%>
                    <div id="divPersonal" style="display: block;" class="form-group panel-body">
                            ...
                            <div class="col-sm-9" style="padding: 0">
                                <div class="col-sm-2">
                                    <asp:UpdatePanel ID="upcboTitle" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="cboTitle" runat="server" CssClass="form-control" DataTextField="ParamDesc" Visible="true"
                                                DataValueField="ParamValue" AppendDataBoundItems="True" TabIndex="6">
                                            </asp:TextBox>
                                            <asp:DropDownList ID="cboTitlee" runat="server" CssClass="form-control" DataTextField="ParamDesc" Visible="false"
                            ...
                            <div class="col-sm-9" style="padding: 0">
                                <div class="col-sm-2">
                                    <asp:UpdatePanel ID="ipcboTitle1" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="cboTitle1" runat="server" CssClass="form-control" DataTextField="ParamDesc" Visible="true"
                                                DataValueField="ParamValue" AppendDataBoundItems="True" TabIndex="10">
                                            </asp:TextBox>
                                            <asp:DropDownList ID="cboTitle11" runat="server" CssClass="form-control" DataTextField="ParamDesc" Visible="false"
                                                DataValueField="ParamValue" AppendDataBoundItems="True" TabIndex="10">
                                            </asp:DropDownList>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                ...
                                <div class="col-sm-10" style="padding: 0">
                                    <div class="col-sm-4" style="padding-left: 0">
                                        <asp:TextBox ID="txtGivenName1" runat="server" CssClass="form-control" onkeypress="return lettersOnly();" onchange="javascript:this.value=this.value.toUpperCase();"
                                            MaxLength="50" TabIndex="11">
                                        </asp:TextBox>
                                    </div>
                                    <div class="col-sm-4" style="padding-left: 0">
                                        <asp:TextBox ID="txtMiddleName1" runat="server" CssClass="form-control" onkeypress="return lettersOnly();" onchange="javascript:this.value=this.value.toUpperCase();"
                                            MaxLength="50" TabIndex="12">
                                        </asp:TextBox>
                                    </div>
                                    <div class="col-sm-4" style="padding-left: 0">
                                        <asp:TextBox ID="txtLastName1" runat="server" CssClass="form-control" onkeypress="return lettersOnly();" onchange="javascript:this.value=this.value.toUpperCase();"
                            ...
                            <div class="col-sm-9" style="padding: 0">
                                <div class="col-sm-2">
                                    <asp:UpdatePanel ID="upcboTitle2" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="cboTitle2" runat="server" CssClass="form-control" DataTextField="ParamDesc" Visible="true"
                                                DataValueField="ParamValue" AppendDataBoundItems="True" TabIndex="15">
                                            </asp:TextBox>
                                            <asp:DropDownList ID="cboTitle22" runat="server" Visible="false" CssClass="form-control" DataTextField="ParamDesc" onchange="CheckFatherSpouce('FatherPrefix')"
                                ...
                                <div class="col-sm-10" style="padding: 0">
                                    <div class="col-sm-4" style="padding-left: 0">
                                        <asp:TextBox ID="txtGivenName2" runat="server" CssClass="form-control" onkeypress="return lettersOnly();" onchange="javascript:this.value=this.value.toUpperCase();"
                                            MaxLength="30" TabIndex="16">
                                        </asp:TextBox>
                                    </div>

                                    <div class="col-sm-4" style="padding-left: 0">
                                        <asp:TextBox ID="txtMiddleName2" runat="server" CssClass="form-control" onkeypress="return lettersOnly();" onchange="javascript:this.value=this.value.toUpperCase();"
                                    ...
                                    <div class="col-sm-4" style="padding-left: 0">
                                        <asp:TextBox ID="txtLastName2" runat="server" CssClass="form-control" onkeypress="return lettersOnly();" onchange="javascript:this.value=this.value.toUpperCase();"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9" style="padding: 0">
                                <div class="col-sm-2">
                                    <asp:TextBox ID="cboTitle3" runat="server" CssClass="form-control" DataTextField="ParamDesc" Visible="true"
                                        DataValueField="ParamValue" AppendDataBoundItems="True" TabIndex="19">
                                    </asp:TextBox>
                                    <asp:DropDownList ID="cboTitle33" runat="server" CssClass="form-control" DataTextField="ParamDesc" Visible="false"
                                        DataValueField="ParamValue" AppendDataBoundItems="True" TabIndex="19">
                                    </asp:DropDownList>
                                </div>
                                <div class="col-sm-10" style="padding: 0">
                                    <div class="col-sm-4" style="padding-left: 0">
                                        <asp:TextBox ID="txtGivenName3" runat="server" onkeypress="return lettersOnly();" CssClass="form-control" onchange="javascript:this.value=this.value.toUpperCase();"
                                            MaxLength="50" TabIndex="20">
                                        </asp:TextBox>
                                    </div>

                                    <div class="col-sm-4" style="padding-left: 0">
                                        <asp:TextBox ID="txtMiddleName3" runat="server" CssClass="form-control" onkeypress="return lettersOnly();" onchange="javascript:this.value=this.value.toUpperCase();"
                                            MaxLength="50" TabIndex="21">
                                        </asp:TextBox>
                                    </div>

                                    <div class="col-sm-4" style="padding-left: 0">
                                        <asp:TextBox ID="txtLastName3" runat="server" CssClass="form-control" onkeypress="return lettersOnly();" onchange="javascript:this.value=this.value.toUpperCase();"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3" id="DivDob" runat="server" style="display: block">
                            ...
                            <div class="col-sm-3" id="DivDob1" runat="server" style="display: none">
                                <div class="input-group">
                                    <asp:TextBox ID="txtDOB1" runat="server" CssClass="form-control" placeholder="dd-mm-yyyy" onchange="ValidateDOB(this.value);" MaxLength="10" TabIndex="2"></asp:TextBox>
                            ...
                            <div class="col-sm-3">
                                <asp:UpdatePanel ID="upcboGender" runat="server">
                                    <ContentTemplate>
                                        <asp:TextBox ID="cboGender" runat="server" CssClass="form-control" TabIndex="24" Visible="true">
                                        </asp:TextBox>
                                        <asp:DropDownList ID="cboGender1" runat="server" CssClass="form-control" Visible="false" TabIndex="24" ClientIDMode="Static" onchange="CheckGenderPrefix('gender')">
                                        </asp:DropDownList>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3" style="text-align: left">
                                <asp:TextBox runat="server" ID="txtPanNo" CssClass="form-control" OnTextChanged="txtPanNo_TextChanged" value="CHKPD0262R" Enabled="false"
                                    ClientIDMode="Static" AutoPostBack="true" onblur="return validatePAN(this)" onkeyup="javascript: this.value = this.value.toUpperCase()" TabIndex="29" />
                            </div>
                            <div class="col-sm-3">
                                <asp:CheckBox ID="chkPanForm" Text="&nbsp;&nbsp;Form 60 furnished" OnCheckedChanged="chkPanForm_CheckedChanged" Enabled="false"
                ...
                <div class="panel panel-success" style="display: none">
                    ...
                    <div id="div3" style="display: block;" runat="server" class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <asp:TextBox CssClass="form-control" onmousedown="$('#txtDob').datepicker({ changeMonth: true, changeYear: true });"
                                    onchange="ValidateDOB(this.value);" runat="server" ID="txtIDResTax" MaxLength="10"
                                    TabIndex="33" />
                            </div>
                        </div>
                        <div class="row">
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            <ContentTemplate>
                <div class="panel panel-success" style="display:none">
                    <div id="Div4" class="panel-heading" style="height: 47px; padding-top: 14px; display:none" >
                        <div class="row">
                            <div class="col-sm-3" style="text-align: left">
                                <span class="glyphicon glyphicon-menu-hamburger"></span>
                            ...
                            <div class="col-sm-3" style="text-align: right">
                                <asp:CheckBox ID="checkProofofIDDtlupdFlag" AutoPostBack="true" Text="&nbsp;&nbsp;UPDATE IDENTITY DETAILS " Style="padding-left: 10px;"
                                    CssClass="standardcheckbox" runat="server" OnCheckedChanged="checkProofofIDDtlupdFlag_CheckedChanged"
                                    TabIndex="31" />
                            </div>

                            <div class="col-sm-1">
                                <span id="btnProofIdentity" onclick="showHideDiv('menu2','btnProofIdentity');return false;" class="glyphicon glyphicon-collapse-down" style="float: right; padding: 1px 10px ! important; font-size: 18px;"></span>
                            </div>
                        </div>
                    </div>
                    <div id="menu2" class="panel-body">
                       ...
                       <%-- <div class="row">
                            ...
                            <div class="col-sm-3">
                                <asp:TextBox ID="ddlProofIdentity" runat="server" CssClass="form-control" AutoPostBack="true" Visible="true"
                                    TabIndex="36">
                                </asp:TextBox>
                                <asp:DropDownList ID="ddlProofIdentity1" runat="server" CssClass="form-control" AutoPostBack="true" Visible="false"
        ...
        <asp:UpdatePanel ID="upMenu3" runat="server">
            <ContentTemplate>
                <div id="menu3" class="panel panel-success">
                    <%--  Added for Proof of Address start--%>
                    <%--<div class="panel panel-success">--%>
                    <div id="Div6" runat="server" class="panel-heading" style="height: 47px; padding-top: 14px;">
                        <div class="row">
                            <div class="col-sm-6" style="text-align: left">
                                <span class="glyphicon glyphicon-menu-hamburger"></span>
                                <asp:Label ID="lblpfofAddr2" Text="PROOF OF IDENTITY AND ADDRESS" runat="server" CssClass="control-label"></asp:Label>
                            </div>
                            ...
                            <div class="col-sm-3" style="text-align: right">
                                <asp:CheckBox ID="checkAddressDtlupdFlag" AutoPostBack="true" Text="&nbsp;&nbsp;UPDATE ADDRESS DETAILS" Style="padding-left: 10px;"
                                    CssClass="standardcheckbox" runat="server" OnCheckedChanged="checkAddressDtlupdFlag_CheckedChanged"
                                    TabIndex="31" />
                            </div>

                            <div class="col-sm-1" onclick="showHideDiv('EmptyPagePlaceholder_div7','Span2');return false;">
                    ...
                    <div id="div7" style="display: block;" runat="server" class="panel-body">
                        ...
                        <%--<div class="row">
                                    <div class="col-sm-12" style="text-align: left">
                                        <asp:CheckBox ID="checkAddressDtlupdFlag" AutoPostBack="true" Text="&nbsp;&nbsp;Address Details Update Flag" Style="padding-left: 10px;"
                                            CssClass="standardcheckbox" runat="server" OnCheckedChanged="checkAddressDtlupdFlag_CheckedChanged"
                                            TabIndex="31" />
                                    </div>
                                </div>--%>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3" style="text-align: left">
                                <asp:Label ID="lblProofOfAddress" Text="Document Name" runat="server" CssClass="control-label"></asp:Label>
                                <span><font color="red">*</font></span>
                            </div>
                            <div class="col-sm-3">
                                ...
                                <asp:DropDownList ID="ddlProofOfAddress1" runat="server" Visible="false" AutoPostBack="true" OnSelectedIndexChanged="ddlProofOfAddress1_SelectedIndexChanged"
                        ...
                        <div id="divAddProof" runat="server" class="row" >
                            ...
                            <div id="divPassNotxtAdd" runat="server" class="col-sm-3">
                             ...
                             <div  runat="server" class="col-sm-3" style="display:none">
                                <div class="input-group">
                                    ...
                                    <asp:TextBox CssClass="form-control" runat="server" onChange="javascript:this.value=this.value.toUpperCase();"
                                         MaxLength="20" TabIndex="37" onkeypress="funIsAlphaNumeric()" />
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <asp:TextBox ID="ddlDistrict" runat="server" CssClass="form-control" Enabled="false"
                                 ...
                                 <asp:DropDownList ID="DDDistrict" runat="server" CssClass="form-control" Visible="false"
                                    TabIndex="50">
                                    <asp:ListItem Value="" Text="Select"></asp:ListItem>
                                </asp:DropDownList>
                            </div>
                            ...
                            <div class="col-sm-3">
                                ...
                                <asp:DropDownList ID="DDPinCode" runat="server" CssClass="form-control"  Visible="false" 
                                    AutoPostBack="True" TabIndex="51" OnSelectedIndexChanged="DDPinCode_SelectedIndexChanged">
                                    <asp:ListItem Value="" Text="Select"></asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                ...
                                <asp:DropDownList ID="DDState" runat="server" CssClass="form-control" Visible="false"
                                    TabIndex="52">
                                    <asp:ListItem Value="" Text="Select"></asp:ListItem>
                                </asp:DropDownList>
                            </div>
                            ...
                            <div class="col-sm-3">
                                ...
                                <asp:TextBox ID="txtCountryCode" runat="server" CssClass="form-control" AutoPostBack="true"
                                 ...
                                 <asp:DropDownList ID="ddlCountryCode" runat="server"  CssClass="form-control" AutoPostBack="true" Visible="false"
                                    OnSelectedIndexChanged="ddlCountryCode_SelectedIndexChanged" TabIndex="53">
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div style="margin-top: 25px; margin-bottom: 25px">
                            <div class="row">
                                <div class="col-sm-12" style="text-align: left">
                                    <asp:CheckBox ID="chkLocalAddress" Text="&nbsp;&nbsp;CORRESPONDENCE/LOCAL ADDRESS DETAILS" runat="server" Visible="false"
                                        CssClass="control-label" TabIndex="54" />
                                    <asp:Label ID="Label5" Text="CURRENT ADDRESS DETAILS" runat="server" CssClass="control-label" TabIndex="54" Style="font-weight: 700;"></asp:Label>
                                    <span><font color="red">*</font></span>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12" style="text-align: left">
                                    <asp:CheckBox ID="chkCuurentAddress" Text="&nbsp;&nbsp;Same as above mentioned address"
                                        AutoPostBack="true" runat="server" OnCheckedChanged="chkCuurentAddress_CheckedChanged"
                            ...
                            <div class="row">
                            <div class="col-sm-3" style="text-align: left">
                                <asp:Label ID="lblProof" Text="Document Name"
                                    runat="server" CssClass="control-label"></asp:Label>
                                <span><font color="red">*</font></span>
                            </div>
                            <div class="col-sm-3">
  ...
  <div id="divIdProof" runat="server" class="row">
      ...
      <div id="div25" runat="server" class="col-sm-3" style="display:none">
                                    <div class="input-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <asp:DropDownList ID="DDDistrict1" runat="server" CssClass="form-control" Visible="false"
                                    TabIndex="50">
                                    <asp:ListItem Value="" Text="Select"></asp:ListItem>
                                </asp:DropDownList>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <asp:TextBox ID="ddlPinCode1" runat="server" CssClass="form-control"
                                     ...
                                     <asp:DropDownList ID="DDPinCode1" runat="server" CssClass="form-control"  Visible="false"
                                    AutoPostBack="True" TabIndex="51" OnSelectedIndexChanged="DDPinCode1_SelectedIndexChanged">
                                    <asp:ListItem Value="" Text="Select"></asp:ListItem>
                                </asp:DropDownList>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <asp:TextBox ID="ddlState1" runat="server" CssClass="form-control" Enabled="false"
                                     ...
                                     <asp:DropDownList ID="DDState1" runat="server" CssClass="form-control" Visible="false"
                                    TabIndex="52">
                                    <asp:ListItem Value="" Text="Select"></asp:ListItem>
                                </asp:DropDownList>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtCountryCode1" runat="server" CssClass="form-control" AutoPostBack="true"
                                     ...
                                     <asp:DropDownList ID="ddlCountryCode1" runat="server" CssClass="form-control" AutoPostBack="true" Visible="false"
                                    OnSelectedIndexChanged="ddlCountryCode1_SelectedIndexChanged" TabIndex="53">
                                </asp:DropDownList>
                                </div>
                            </div>
                        </div>
        ...
        <asp:UpdatePanel ID="updCD" runat="server">
            <ContentTemplate>
                <div class="panel panel-success" style="margin-left: 0px; margin-right: 0px">
                    <div id="Div8" runat="server" class="panel-heading subheader" style="height: 47px; padding-top: 14px;">
                        <div class="row">
                            ...
                            <div class="col-sm-3" style="text-align: right">
                                <asp:CheckBox ID="checkContactDtlupdFlag" AutoPostBack="true" Text="&nbsp;&nbsp;UPDATE CONTACT DETAILS" Style="padding-left: 10px;"
                                    CssClass="standardcheckbox" runat="server" OnCheckedChanged="checkContactDtlupdFlag_CheckedChanged"
                                    TabIndex="31" />
                            ...
                            <div class="col-sm-1" onclick="showHideDiv('EmptyPagePlaceholder_div9','Span3');return false;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    ...
                                    <asp:TextBox ID="txtTelRes2" runat="server" CssClass="form-control" MaxLength="10" onblur="fnValidateNumber(this.id,'8');" onkeypress="fncInputNumericValuesOnly();"
        ...
        <%--</div>--%>
           <asp:UpdatePanel ID="UpdatePanel5" runat="server">
            <ContentTemplate>
        <div class="panel panel-success">
            <div id="Div21" runat="server" class="panel-heading"  style="height: 47px; padding-top: 14px;">
                <div class="row">
                    <div class="col-sm-3" style="text-align: left">
                        <span class="glyphicon glyphicon-menu-hamburger"></span>
                        <asp:Label ID="lblDtlOfRtltpr" Text="RELATED PERSON" runat="server" CssClass="control-label">
                        </asp:Label>
                    </div>
                    <div class="col-sm-2" style="text-align: left">
                    </div>
                    ...
                    <div class="col-sm-4" style="text-align: right">
                        <asp:CheckBox ID="checkUpdRelatContactDtlFlag" AutoPostBack="true" Text="&nbsp;&nbsp;UPDATE RELATED PERSON DETAILS" Style="padding-left: 10px;"
                            CssClass="standardcheckbox" runat="server"
                            TabIndex="31" />
                    </div>
                    <div class="col-sm-1" onclick="showHideDiv('menu4','Span10');return false;">
        ...
        <asp:UpdatePanel ID="updOD" runat="server">
            <ContentTemplate>
        <div class="panel panel-success">
            <div id="Div22" class="panel-heading subheader"  style="height: 47px; padding-top: 14px;">
                <div class="row">
                    <div class="col-sm-7" style="text-align: left">
                        <span class="glyphicon glyphicon-menu-hamburger"></span>
                        <asp:Label ID="lblRemarks" Text="OTHER DETAILS" runat="server" CssClass="control-label">
                        </asp:Label>
                    </div>
                    <div class="col-sm-1" style="text-align: left">
                    </div>
                    ...
                    <div class="col-sm-3" style="text-align: right">
                      <asp:CheckBox ID="checkOtherupdFlag" AutoPostBack="true" Text="&nbsp;&nbsp;UPDATE OTHER DETAILS" Style="padding-left: 10px;"
                            CssClass="standardcheckbox" runat="server" OnCheckedChanged="checkOtherupdFlag_CheckedChanged"
                            TabIndex="31" />
                    </div>
                    <div class="col-sm-1" onclick="showHideDiv('menu5','Span11');return false;">
            ...
            <ContentTemplate>
                <div class="panel panel-success">
                    <div id="Div23" runat="server" class="panel-heading"  style="height: 47px; padding-top: 14px;">
                        <div class="row">
                            <div class="col-sm-3" style="text-align: left">
                                <span class="glyphicon glyphicon-menu-hamburger"></span>
                                <asp:Label ID="lblattstn" Text="KYC VERIFICATION DETAILS" runat="server" CssClass="control-label">
                                </asp:Label>
                            </div>
                            <div class="col-sm-2" style="text-align: left">
                            </div>
                            ...
                            <div class="col-sm-4" style="text-align: right">
                                <asp:CheckBox ID="checkvrifiDtlupdFlag" AutoPostBack="true" Text="&nbsp;&nbsp;UPDATE KYC VERIFICATION DETAILS" Style="padding-left: 10px;"
                                    CssClass="standardcheckbox" runat="server" OnCheckedChanged="checkvrifiDtlupdFlag_CheckedChanged" 
                                    TabIndex="31" />
                            </div>
                            <div class="col-sm-1" onclick="showHideDiv('menu6','Span12');return false;">
                        ...
                        <div class="panel panel-success">
                            ...
                            <div id="div17" style="display: block;" runat="server" class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <asp:CheckBox ID="chkCertifyCopy" Text="Certified Copies" CssClass="standardcheckbox"
                                            Enabled="false" AutoPostBack="true" runat="server" TabIndex="101" Visible="false" />
                                           <asp:DropDownList ID="ddlDocReceived" runat="server" CssClass="form-control" TabIndex="2" Enabled="false">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <asp:TextBox CssClass="form-control" onmousedown="$('#EmptyPagePlaceholder_txtDateKYCver').datepicker({ changeMonth: true, changeYear: true });"
                                    ...
                                    <div class="col-sm-3">
                                        <asp:TextBox CssClass="form-control" runat="server" ID="txtEmpName" MaxLength="15" onkeypress="return lettersOnly();" onchange="javascript:this.value=this.value.toUpperCase();"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <asp:TextBox CssClass="form-control" runat="server" ID="txtInsName" MaxLength="15" onkeypress="return lettersOnly();" onchange="javascript:this.value=this.value.toUpperCase();"
        ...
        <div id="divImageBind" runat="server" class="panel panel-success">
            <div id="div13" class="panel-heading subheader" onclick="showHideDiv('divPhoto','btnImage');return false;" style="height: 47px; padding-top: 14px;">
                <div class="row">
                    <div class="col-sm-3" style="text-align: left; top: 0px; left: 0px;">
                        <span class="glyphicon glyphicon-menu-hamburger"></span>&nbsp;IMAGE DETAILS
                    ...
                    <div class="col-sm-3" style="text-align: right">
                        <asp:CheckBox ID="CheckBox3" AutoPostBack="true" Text="&nbsp;&nbsp;UPDATE IMAGE DETAILS" Style="padding-left: 10px;"
                            CssClass="standardcheckbox" runat="server"
                            TabIndex="31" />
                    </div>
                    <div class="col-sm-1">
        ...
        <div class="panel panel-success" id="divmvmt" runat="server">
            <div id="cndmvmt" runat="server" class="panel-heading" onclick="showHideDiv('divCndMvmt','Span4');return false;">
                <div class="row" id="Div26" runat="server">
                    <div class="col-sm-10" style="text-align: left">
                        <span class="glyphicon glyphicon-menu-hamburger"></span>
                        <asp:Label ID="Label12" Text="AUDIT TRAIL" runat="server" CssClass="control-label"></asp:Label>
                    </div>
                    <div class="col-sm-2">
        ...
        <div class="row" style="margin-top: 12px;" id="divbtn">
            <div class="col-sm-12" align="center">
                  ...
                  <asp:LinkButton ID="btnUpdate" 
                    CssClass="btn-animated bg-green" runat="server" TabIndex="109" OnClick="btnUpdate_Click">
                    
                    <span class="glyphicon glyphicon-floppy-disk BtnGlyphicon"></span> Update
                </asp:LinkButton>

                <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btn-animated bg-horrible"  OnClick="btnCancel_Click">
