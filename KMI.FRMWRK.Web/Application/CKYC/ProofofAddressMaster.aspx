<%@ Page Language="C#" MasterPageFile="~/Empty.Master" AutoEventWireup="true" CodeBehind="ProofofAddressMaster.aspx.cs" Inherits="KMI.FRMWRK.Web.Application.CKYC.ProofofAddressMaster" %>
                   ...
                   <%-- <div id="Div21" runat="server" class="panel-heading">
                        <div class="row">
                            <div class="col-sm-10" style="text-align: left">
                                ...
                                <asp:Label ID="lblDtlOfRtltpr" Text="Proof of Address Master"
                    ...
                    <div id="menu4" style="padding-left: 30px;display: block;padding-right: 30px;text-align: -webkit-center;" class="panel-body">
                        ...
                        <div class="row" style="width:90%;">
                            ...
                            <asp:GridView ID="gvProofOfAddMaster" Width="100%" runat="server" AllowSorting="True" CssClass="footable"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Proof of Address Code" HeaderStyle-CssClass="Lpad Center"  ItemStyle-CssClass="text-center" ItemStyle-Width="10%" SortExpression="Reference No.">
                                        <ItemTemplate>
                                            <asp:Label ID="lblRefNo" runat="server" Text='<%# Eval("Code") %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle CssClass="pad Center" HorizontalAlign="Center" Width="10%" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Proof of Address Description" HeaderStyle-CssClass="Lpad Center" ItemStyle-Width="20%" SortExpression="Reference No.">
                                        <ItemTemplate>
                                            <asp:Label ID="lblRelTypVal" runat="server" Text='<%# Eval("Description") %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle CssClass="pad left" HorizontalAlign="Center" Width="30%" />
                                    </asp:TemplateField>
                                </Columns>
