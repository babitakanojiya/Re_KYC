...
namespace KMI.FRMWRK.Web.Application.CKYC
{
    public partial class CkycSearch : System.Web.UI.Page
    {
        ...
        protected void lblMail_Click(object sender, EventArgs e)
        {
            GridViewRow clickedRow = ((LinkButton)sender).NamingContainer as GridViewRow;

            HiddenField hdnKycNoM = (HiddenField)clickedRow.FindControl("hdnKycNoM");
            string ckyc = hdnKycNoM.Value.ToString();
            string Flag = "Mail";




            //string Ckyc = hdnKycNo.Value.ToString();

            ScriptManager.RegisterStartupScript(this, this.GetType(), "UniqueID", "openPopup('" + ckyc + "','" + Flag + "');", true);
        }

        protected void lblKIN_Click(object sender, EventArgs e)
        {
            GridViewRow clickedRow = ((LinkButton)sender).NamingContainer as GridViewRow;
