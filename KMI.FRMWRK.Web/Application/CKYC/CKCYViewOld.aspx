<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CKCYViewOld.aspx.cs" Inherits="KMI.FRMWRK.Web.Application.CKYC.CKCYViewOld" %>
...
<asp:content id="Content2" contentplaceholderid="EmptyPagePlaceholder" runat="server">
    <span style="color: rgb(51, 51, 51); font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; font-style: normal; font-variant: normal; font-weight: normal; letter-spacing: normal; line-height: 20px; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 1; word-spacing: 0px; -webkit-text-stroke-width: 0px; display: inline !important; float: none; background-color: rgb(255, 255, 255);">bsp;</span><asp:ScriptManager ID="SM1" runat="server">
        <Scripts>
    ...
    <div class="container" style="margin-top: 0px; width: 100%;">
        ...
        <asp:UpdatePanel ID="Updatepanel3" runat="server">
            <ContentTemplate>
     <div class="panel panel-success">
                    <div id="Div19" class="panel-heading" onclick="showHideDiv('menu1','Span8');return false;">                                                  <div class="row">
                            <div class="col-sm-10" style="text-align: left">
                                <span class="glyphicon glyphicon-menu-hamburger"></span>
                         ...
                         <div class="panel panel-success">
                            <div id="Div1" runat="server" class="panel-heading subheader"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        <span id="Span1" class="glyphicon glyphicon-resize-full" style="float: right;
                                            padding: 1px 10px ! important; font-size: 18px;"></span>
                                    </div>
                                </div>
                            </div>
         ...
         <div class="panel panel-success">
            <div id="Div21" runat="server" class="panel-heading"  onclick="showHideDiv('menu4','Span10');return false;">
                <div class="row">
                    <div class="col-sm-10" style="text-align: left">
                        <span class="glyphicon glyphicon-menu-hamburger"></span>
                        <asp:Label ID="lblDtlOfRtltpr" Text="CONTACT DETAILS OF RELATED PERSON(All communication will be sent on provided MobileNo./Email-ID)"
                 ...
                 <div class="panel panel-success">
                    <div id="Div14" runat="server" class="panel-heading subheader"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <span id="Span6" class="glyphicon glyphicon-resize-full" style="float: right;
                                    padding: 1px 10px ! important; font-size: 18px;"></span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12" style="text-align: left; display: flex; font-weight: bold;">
                                <asp:Label CssClass="control-label" Text="there in immediately.In case any of the above information is found to be false or untrue or misleading or misrepresenting. I am aware that I may be held   liable for it."
                                    onchange="setDateFormat('txtRemarks')" runat="server" ID="lblAppDeclare1" /></div>
                            <br />
                            <br />
                            <br />
                            <div class="col-sm-12" style="text-align: left; display: flex;">
                 ...
                 <div class="panel panel-success">
                    <div id="Div16" runat="server" class="panel-heading subheader"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <span id="Span7" class="glyphicon glyphicon-resize-full" style="float: right;
                                    padding: 1px 10px ! important; font-size: 18px;"></span>
                            </div>
                        </div>
                    </div>
         ...
         <div id="divImageBind" runat="server" class="panel panel-success">
                    ...
                    <div id="divPhoto" runat="server" class="panel-body" >
                        <div class="row" style="text-align: left;display: none" >
                            ...
                            <div class="col-sm-2" style="display: none">
                                <font color="darkorange">Responded CFR</font> <span id="respond" runat="server" class="badge">
                                    10</span></div>
                            <div class="col-sm-2" style="display: none">
                                <font color="blue">Closed CFR </font><span id="close" runat="server" class="badge">10</span></div>
                            <div class="col-sm-2">
                                <font color="green">Approved Document</font> <span id="approvedoc" runat="server"
                                    class="badge">10</span></div>
            ...
            <div class="modal-content"  >
                ...
                <div class="modal-body">
                    <div id="img-preview" style="height:310px;">
                        <asp:Image ID="img3" runat="server" class="image-box" Style="cursor: move;" /></div>
                    <div class="img-op">
            ...
            <div class="modal-content" style="width: 90%;max-width: 100%;">
                <div class="modal-header" style="margin-top: -10px; margin-bottom: -20px; padding-bottom: 6px ! important;">
                    ...
                    <h4 class="modal-title" id="myModalLabel">
                        CKYC Related Person Details</h4>
                </div>
                <div class="modal-body">
                    <iframe id="iframeCFR" src="" width="100%" height="505" frameborder="0" allowtransparency="true">
                    </iframe>
                </div>
