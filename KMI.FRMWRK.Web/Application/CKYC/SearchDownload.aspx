...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ShowProgressBar(Msg,time=2000) {
            debugger;
            var Msg = Msg
            ...
            setTimeout(function () { HideProgressBar(); }, time);
        }
    ...
    <script>
        ...
        function showOtherDocs() {
            ...
            if (nid =="btnvoter"){
                ...
                document.getElementById("lblotherdocs").textContent="Passport Number: "
                document.getElementById("docspara").textContent="Please enter the Passport Number and the DOB Details."
            }
        }
        function hideDiv(toHide, toShow,time=2000) {
            document.getElementById(toHide).style.display = "none";         
            ShowProgressBar('Loading...',time);
            setTimeout(function () {
                                ...
                                <div class="panel-body">
                                    ...
                                    <div id="CKYCpage1" class="page-div" style="display:none;">
                                        ...
                                        <div style="display: flex; justify-content: center; margin-top: 20px;gap:6rem;">
                                            <button type="button" id="ckycyes" class="btn btn-lg" style="width: 13rem;border-radius: 5rem; font-weight:600; background-color:#1f50a7; color: white; " onclick="hideDiv('CKYCpage1','CKYCpage2')">
                                                YES I DO HAVE  

                                            </button>
                                            <button type="button" id="ckycno"class="btn btn-light btn-lg" style="width: 13rem;border-radius: 5rem;border:0.2rem solid #1f50a7; font-weight:600; color:#1f50a7" onclick="hideDiv('CKYCpage1','PANpage1')">
                                                NO I DON'T HAVE  
                                            </button>
...
<%--                                        <h3 style="color:blue; font-weight:bold; font-size: 12px; margin-top: 7px; ">Please enter your 14 digit CKYC number and Date of Birth</h3>--%>
                                        ...
                                        <div class="center-margin">
                                            ...
                                            <div style="display: flex; justify-content: center; margin-top: 20px; gap: 6rem;">
                                                <button
                                                    ...
                                                    style="width: 13rem; border-radius: 5rem; font-weight:bold;background-color:#1f50a7; font-weight:600; color: white;"
                                                    onclick="CKYCPANValidate();">
                                                    SUBMIT</button>

                                                <button type="button" id="panclear" class="btn btn-light btn-lg" style="width: 13rem; border-radius: 5rem; font-weight:600; border: 0.2rem solid blue; color:#1f50a7; " onclick="resetFields('<%= PanNo.ClientID %>','<%= pandob.ClientID %>')">
                                                    CLEAR
                                                </button>
    ...
    <div style="text-align: center; margin-top:10px; font-size:medium;">
        ...
        <!-- Cards + Divider -->
        <div class="d-flex justify-content-center flex-wrap gap-4 align-items-stretch mt-0">
            <!-- CKYC Card -->
            <div id="ckyccard" style="width: 420px;height: 232px;">
                <div class="card shadow-lg p-4 bg-white rounded-4 h-100" style="max-width: 45rem;background: linear-gradient(to bottom, #95e6fb, #ccf3fa);">
                    <div class="row text-center mb-0">
                        <div class="col-9">
                            <div style="font-size: 1.2rem;color: #1f50a7;font-weight: bold;">KYC DETAILS REGISTERED WITH</div>
                            <div style="font-size: 1.2rem;color: #1f50a7;font-weight: bold;">CENTRAL KYC RECORDS REGISTRY</div>
                        </div>
                        <div class="col-3">
                            <img src="Images/CERSAI_Symbol.png" alt="CERSAI Symbol" style="height: 46px;">
                        </div>
                    </div>
            ...
            <!-- PAN Card -->
            <div id="pancard" style="width: 420px;height: 232px;">
                <div class="card shadow-lg p-4 bg-white rounded-4 h-100 position-relative"
                    ...
                    <div class="row text-center mb-3">
                        ...
                        <div class="col-4">
                            <img src="Images/NewIndianEmblem.JPG" alt="Emblem of India"
                                 style="height: 36px; mix-blend-mode: color-burn;">
                        </div>
                        <div class="col-4">
                    ...
                    <!-- Details + QR + Photo -->
                    <div class="row">
                        <div class="col-md-8 col-12 text-start ps-4">
                            <div class="mb-3">
                                <span style="color:#073b97">NAME</span><br />
                                <asp:Label ID="lblAccountName" runat="server" Text=""/>
                            </div>
                            <div class="mb-3">
                                <span style="color:#073b97">PERMANENT ACCOUNT NUMBER:</span><br />
                                <asp:Label ID="lblAccountNumber" runat="server" Text="" />
                            </div>

                            <!-- Signature -->
                            <div class="d-none d-md-block position-absolute ps-2" style="bottom: 0rem; left: 1rem;">
                                <span style="color:#073b97">SIGNATURE</span>
                            </div>
                        ...
                        <div class="col-md-4 col-12 d-flex flex-column align-items-center justify-content-end mt-3 mt-md-0">
                            ...
                            <img runat="server" src="~/application/ckyc/images/PersonSample.JPG" id="Img4"
                                 alt="applicant's photo" class="border border-2 shadow-sm"
                                 style="margin-top:0rem;width: 80px; height: 80px; object-fit: cover; border-radius: 1rem;" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <button type="button" id="bckbtndata" class="btn btn-secondary btn-lg"
                ...
                BACK
                                    ...
                                    <div id="Aadharpage1" class="page-div" style="display:none;">
                                        ...
                                        <div style="display: flex; justify-content: center; margin-top: 20px;gap:6rem;">
                                        <button type="button" id="aadharyes" class="btn btn-primary btn-lg" style="width: 13rem;border-radius: 5rem;font-weight:600;" onclick="hideDiv('Aadharpage1','Aadharpage2')">
                                                YES I DO HAVE
                                        </button>
                                        <button type="button" id="aadharno"class="btn btn-light btn-lg" style="width: 13rem;border-radius: 5rem;border:0.2rem solid blue;font-weight:600;" onclick="hideDiv('Aadharpage1','OtherDocs')">
                                                NO, I DON'T HAVE
                                        </button>
                                ...
                                <div style="display: flex; justify-content: center; margin-top: 20px;gap:6rem;">
                                    ...
                                    <button type="button" id="searchaadhar" class="btn btn-primary btn-lg" style="width: 13rem;border-radius: 5rem; font-weight:600;" onclick="validateAadhaar();">
                                            SEARCH
                                    </button>
                                    <button type="button" id="clearaadhar"class="btn btn-light btn-lg" style="width: 13rem;border-radius: 5rem;border:0.2rem solid blue;font-weight:600;" onclick="resetFields('aadhaarNumber','fullName','dob','gender')">
                                            CLEAR
                                    </button>
                                        <button type="button" class="btn btn-secondary btn-lg"
                                        style="width: 10rem; border-radius: 5rem; font-weight:600;"
    ...
    <button class="btn btn-outline-primary btn-lg" style="border-radius: 5rem;">
        <span class="bi bi-arrow-down" style="display: inline-block; border-bottom: 2px solid currentColor; padding-bottom: 0px;"></span>
                                    ...
                                    <div style="display: flex; justify-content: center; margin-top: 20px;gap:6rem;">
                                        ...
                                        <button type="button" id="btndrivinglic"class="btn btn-light btn-lg verification-btn"  onclick="btnclicked('btndrivinglic')">
                                         ...
                                         <button type="button" id="btnvoter"class="btn btn-light btn-lg verification-btn" onclick="btnclicked('btnvoter')">
                                            ...
                                            <div id="divotherdocsdata" style="display:none;margin:3%">
                                                <h3 id="docspara">Enter the voter id and DOB Details.</h3>
                                           <div style="margin-top: 3%; display: flex; justify-content: center; gap: 30px; flex-wrap: wrap;">
                                                <!-- CKYC Number -->
                                            <div style="text-align: left;">
                                            <label id="lblotherdocs" style="font-size:1.3rem;">Voter ID Number:</label><br />
                                            <asp:TextBox ID="txtotherdocnumber" runat="server" MaxLength="14" Width="220px" placeholder="e.g. 29473186504217" style=" border-radius: 10px;font-size:1.3rem;" CssClass="form-control"/>
                                            </div>
 
                                              <!-- Date of Birth -->
                                            <div style="text-align: left;">
                                            <label for="lblotherdob" style="font-size:1.3rem;">Date of Birth:</label><br />
                                            <asp:TextBox ID="txtotherdob" runat="server" MaxLength="8" TextMode="Date" Width="220px" style=" border-radius: 10px;font-size:1.3rem;"  CssClass="form-control"/>
                                            </div>
                                            </div>
                                        </div>
                                        </div>
                                    ...
                                    <div style="display: flex; justify-content: center; margin-top: 10%;gap:6rem;">
                                        ...
                                        style="width: 10rem; border-radius: 5rem; font-weight:bold;"
                                        onclick="bckotherdoc();">
                                         BACK
                                    </button>
                                    </div>
