...
namespace KMI.FRMWRK.Web.Application.CKYC
{
    public partial class CkycReg : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                //ScriptManager.RegisterStartupScript(this, this.GetType(), "onclick", "ShowProgressBar('Searching..Please wait');", true);
        ...
        public void ddlcertifiecopy_Changed()
        {
            ...
            else if (ddlProofIdentity.SelectedItem.Text == "Certificate of Incorporation / Formation")
            {
                divIdProof.Visible = true;
            ...
            else if (ddlProofIdentity.SelectedItem.Text == "Registration Certificate")
            {
                divIdProof.Visible = true;
                lblPassportNo.Text = "Document Number";
                txtPassNo.Visible = true;
        ...
        public void ChkPOAPOIDoc()
        {
            ...
            if (ddlProofOfAddress.SelectedItem.Text != "Select")
            {
                if (GridView1.Rows.Count != 0)
                {
                    ...
                    {
                        if (dt1.Rows.Count > 0 && FoundFlag == "F")
                        {
                            if (dt1.Rows[i]["DOC ID Name"].ToString() == ddlProofOfAddress.SelectedItem.Text)
                            {
                                txtPassNoAdd.Text = dt1.Rows[i]["DOC ID Number"].ToString();
                                FoundFlag = "T";
                            }
                            else { FoundFlag = "F"; }
                        }
                ...
                if (FoundFlag == "F")
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alertmsg", "AlertMsg('Please Select " + ddlProofOfAddress.SelectedItem.Text + " in Proof Of Identity')", true);
                    ddlProofOfAddress.SelectedIndex = 0;
                    return;
                }
            }
        ...
        protected void ddlProofOfAddress_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                else if (ddlProofOfAddress.SelectedIndex == 3)
                {
                    ...
                    divAddProof.Visible = true;
                    divPassNoAdd.Visible = true;
                    divPassNotxtAdd.Visible = true;
                    divPassAdd.Visible = false;
                    divPassDateAdd.Visible = false;
                    //txtPassNoAdd.MaxLength = 15;
                    txtPassNoAdd.Text = "";
                    txtPassNoAdd.Attributes.Remove("onblur");
            ...
            try
            {
                ...
                Res = objVal.Validation(ddlAccountType, txtRefNumber, cboTitle, txtGivenName, txtLastName, rbtFS, cboTitle2, txtGivenName2, txtLastName2, cboTitle3, txtGivenName3, txtLastName3, txtDOB, cboGender,
                    ...
                    chkCuurentAddress, txtPassNoAdd1, ddlPinCode1,
                     new TextBox(), new TextBox(), new TextBox(), new TextBox(), new TextBox(), new TextBox(), new TextBox(),
                     ddlCountryCode, ddlCountryCode1, ddlDistrict, ddlDistrict1,
                        ddlState, ddlState1);
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (FlagPageTyp == "Legal")
                {
                   ...
                   ddlProofOfAddress, txtAddressLine1, ddlState, ddlPinCode, ddlCountryCode, ddlState1, ddlPinCode1,
                   ...
                   txtEmpDesignation, txtEmpBranch, txtInsName, txtInsCode, GridView1, txtPassNoAdd, txtemail2);
                }
                #endregion
                ...
                if (Res.Equals(""))
                {
                    ...
                    if (FlagPageTyp == "Indiviual")
                    {
                        ...
                        htParam.Add("@MARITAL_STATUS", "");
                        htParam.Add("@CITIZENSHIP", "");
                        htParam.Add("@PAN", (txtPanNo.Text == "Applied For" ? "" : txtPanNo.Text.Trim()));// Added by Shubham
                        htParam.Add("@RESI_STATUS", "");
                        ...
                        htParam.Add("@AddIdType", "");
                        //Commented by Kalyani Hande start
                        //Added by tushar For Option Add in POA Section
                        if (ddlProofOfAddress.SelectedIndex == 3)
                        {
                            htParam.Add("@AddIdNumber", txtPassNoAdd.Text.Trim());
                            htParam.Add("@AddIdExpDate", txtPassExpDateAdd.Text.Trim());
                    ...
                    if (FlagPageTyp == "Legal")
                    {
                        ...
                        htParam.Add("@TINIssuingCountry", ddlTINCountry.SelectedItem.Text);
                        htParam.Add("@NoOfControlPrsnOI", (dtRel != null && dtRel.Rows.Count > 0) ? dtRel.Rows.Count.ToString() : "0");
                    ...
                    if (ViewState["CurrentData"] != null)
                    {
                        if (ddlProofOfAddress.SelectedItem.Text != "Select")
                        {
                            SaveDocDtls(strRefNo, 0, ddlProofOfAddress.SelectedItem.Text, txtPassNoAdd.Text, "Y");
                        }
                        DataTable dt1 = (DataTable)ViewState["CurrentData"];
                        for (int i = 0; i < dt1.Rows.Count; i++)
                        {
                            if (dt1.Rows.Count > 0)
                            {
                                SaveDocDtls(strRefNo, i + 1, dt1.Rows[i]["DOC ID Name"].ToString(), dt1.Rows[i]["DOC ID Number"].ToString(), "N");
                    ...
                    if (dtRel != null)
                    {
                        if (dtRel.Rows.Count > 0)
                        {
                            for (int i = 0; i < dtRel.Rows.Count; i++)
                            {
                                ...
                                // htParam.Add("@RelRefNo", dt.Rows[i]["RelRefNo"]); //Added by Rutuja
                                htParam.Add("@RelRefNo", dtRel.Rows[i]["RelRefNo"]); //Added by Rutuja
                                ...
                                //htParam.Add("@RelEmailID", dtRel.Rows[i]["Email"]);
                                ...
                                if (dtRel.Rows[i]["AddIdNameRel"].ToString() != "")
                                {
                                    htParam.Add("@AddIdName", dtRel.Rows[i]["AddIdNameRel"]);
                                }
                                else
                                {
                                    htParam.Add("@AddIdName", "");
                                }

                                if (dtRel.Rows[i]["RelPersTypDesc"].ToString() != "")
                                {
                                    htParam.Add("@RelPersTypDesc", dtRel.Rows[i]["RelPersTypDesc"]);
                                }
                                else
                                {
                                    htParam.Add("@RelPersTypDesc", "");
                                }
        ...
        protected void chkAddRel_Checked(object sender, EventArgs e)
        {
            try
            {
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "onclick", "ShowDivProgressBar('Loading..Please wait..');", true);
                //System.Threading.Thread.Sleep(5000);
                //ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "onclick", "HideProgressBar();", true);
                ...
                if (chkAddRel.Checked == true)
                {
                    ...
                    ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alert", "OpenRelatedPersonPopUpPage('" + hdnFiRefNo.Value + "','" + FlagPageTyp + "');", true); //changes by Rutuja
                    lnkViewRel.Enabled = true;
                }
        ...
        protected void lnkdelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                btnReloadRelPersCount_Click(this, e);
            }
            catch (Exception ex)
            {
                if (Session["UserID"].ToString().Trim() == null || Session["UserID"].ToString().Trim() == "")
        ...
        protected void lnkEdit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string RelRefnNo = Convert.ToString(dr[1]);
                string refno = Convert.ToString(dr[0]);//strRefNo;//hdnrefno.Value;// Request.QueryString["refno"].ToString().Trim();
                if (Request.QueryString["Status"].ToString() == "Mod")
                {
        ...
        private void InitializeControls()
        {
            try
            {
                ...
                lblProofOfIdentity11.Text = "PROOF OF IDENTITY";
                ...
                lblOfcuseOnly.Text = "FOR OFFICE USE ONLY";
        ...
        public void ddlproofofAddr_Changed()
        {
            ...
            if (ddlProofOfAddress1.SelectedItem.Text == "Other")
            {
        ...
        protected void btnAddPOI_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (txtPassNo.Text.ToString().Trim() == "" &&
                    (ddlProofIdentity.SelectedItem.Text == "Certificate of Incorporation / Formation" || ddlProofIdentity.SelectedItem.Text == "Registration Certificate"))
                {
        ...
        private void BindGrid(int rowcount)
        {
            ...
            ValPOI.Add(ddlProofIdentity.SelectedItem.Text.ToString(), txtPassNo.Text.ToString());
        ...
        {
            // ScriptManager.RegisterStartupScript(this, this.GetType(), "alertmsg", "AddLoader('ddlNatureOfBussLoader')", true);
            ...
            //ValidatePan();
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alertmsg", "RemoveLoader('ddlNatureOfBussLoader')", true);
        }
        ...
        protected void txtPanNoLegal_TextChanged(object sender, EventArgs e)
        {
            ...
            //ScriptManager.RegisterStartupScript(this, this.GetType(), "alertmsg", "AddLoader('txtPanNoLegalLoader')", true);
            objDAL = new DataAccessLayer("CKYCConnectionString");
            dt = new DataTable();
            htParam.Clear();
            ...
            ValidatePan();
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alertmsg", "RemoveLoader('txtPanNoLegalLoader')", true);
        }

        public void ValidatePan()
        {
            #region Validate PanNo
            if (ddlNatureOfBuss.SelectedIndex != 0)
            {
                // Liquidator-- > Should be any character[A - Z]
                // Public Sector Banks-- > Should be any character[A - Z]
                // Section 8(Companies Act, 2013)-- > Should be any character[A - Z]
                // Not Categorized-- > Should be any character[A - Z]
                // Others-- > Should be any character[A - Z]   Society-- - > Should be any character[A - Z]
                // Foreign Portfolio Investors-- > Should be any character[A - Z]
                string s = "";
                if (txtPanNoLegal.Text != "")
                {
                    s = txtPanNoLegal.Text.ElementAt(3).ToString();
                    if (ddlNatureOfBuss.SelectedValue == "A" && s != "P")//Sole Proprietorship-- > P
                    { ScriptManager.RegisterStartupScript(this, this.GetType(), "alertmsg", "AlertMsg('Please Enter Valid Pan No.')", true); }
                    if (((ddlNatureOfBuss.SelectedValue == "B") || (ddlNatureOfBuss.SelectedValue == "J") || (ddlNatureOfBuss.SelectedValue == "K"))
                        && s != "F")// Partnership Firm --> F  Limited Liability Partnership-- > F  Artificial Liability Partnership-- > F
                    { ScriptManager.RegisterStartupScript(this, this.GetType(), "alertmsg", "AlertMsg('Please Enter Valid Pan No.')", true); }
                    if (ddlNatureOfBuss.SelectedValue == "C" && s != "H")// HUF-- > H
                    { ScriptManager.RegisterStartupScript(this, this.GetType(), "alertmsg", "AlertMsg('Please Enter Valid Pan No.')", true); }
                    if (((ddlNatureOfBuss.SelectedValue == "D") || (ddlNatureOfBuss.SelectedValue == "E")) && s != "C")// Private Limited Company-- > C   Public Limited Company-- > C
                    { ScriptManager.RegisterStartupScript(this, this.GetType(), "alertmsg", "AlertMsg('Please Enter Valid Pan No.')", true); }
                    if (ddlNatureOfBuss.SelectedValue == "M" && s != "L")// Central / State Government Departments / Agency-- > L
                    { ScriptManager.RegisterStartupScript(this, this.GetType(), "alertmsg", "AlertMsg('Please Enter Valid Pan No.')", true); }
                    if (ddlNatureOfBuss.SelectedValue == "O" && s != "J")// Artificial Juridical Person-- > J
                    { ScriptManager.RegisterStartupScript(this, this.GetType(), "alertmsg", "AlertMsg('Please Enter Valid Pan No.')", true); }
                    if (ddlNatureOfBuss.SelectedValue == "P" && s != "G")// International Organisation or Agency / Foreign embasssy or consular office etc. -- > G
                    { ScriptManager.RegisterStartupScript(this, this.GetType(), "alertmsg", "AlertMsg('Please Enter Valid Pan No.')", true); }
                    if (ddlNatureOfBuss.SelectedValue == "G" && ((s != "A") && (s != "B")))// Association of Persons(AOP) / Body of Individuals (BOI)-- > A or B
                    { ScriptManager.RegisterStartupScript(this, this.GetType(), "alertmsg", "AlertMsg('Please Enter Valid Pan No.')", true); }
                    if (ddlNatureOfBuss.SelectedValue == "H" && s != "T") // Trust-- > T
                    { ScriptManager.RegisterStartupScript(this, this.GetType(), "alertmsg", "AlertMsg('Please Enter Valid Pan No.')", true); }
        ...
        protected void txtTypeIdentiNo_TextChanged(object sender, EventArgs e)
        {
            ...
            if (ddlCountrOfInc.SelectedItem.Value == "")
            {
                txtTypeIdentiNo.Text = "";
                msg = "Please select Country of Incorporation.";
                ScriptManager.RegisterStartupScript(this, this.GetType(), "alertmsg", "AlertMsg('" + msg + "')", true);
                return;
            }
            else
            {
                ...
                if (ddlCountrOfInc.SelectedItem.Text == "India")
                {
                    if (txtTypeIdentiNo.Text != "")
                    {
                        if (System.Text.RegularExpressions.Regex.IsMatch(txtTypeIdentiNo.Text, "[0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9][0-9]"))
                        {
                            dvTINCntry.Attributes.Add("style", "display:block");
                            // ddlTINCountry.Visible = true;
                            ddlTINCountry.SelectedItem.Text = ddlCountrOfInc.SelectedItem.Text;
                            ddlTINCountry.Enabled = false;
                        }

                        else if (System.Text.RegularExpressions.Regex.IsMatch(txtTypeIdentiNo.Text, "[0-9][0-9][A-Z][A-Z][A-Z][A-Z][A-Z][0-9][0-9][0-9][0-9][A-Z][0-9][A-Z][0-9A-Z]"))
                        {
                            dvTINCntry.Attributes.Add("style", "display:block");
                            // ddlTINCountry.Visible = true;
                            ddlTINCountry.SelectedItem.Text = "";
                            ddlTINCountry.Enabled = false;
                        ...
                        else
                        {
                            ...
                            msg = "Please enter Valid TIN/GST Registration Number.";
                            ScriptManager.RegisterStartupScript(this, this.GetType(), "alertmsg", "AlertMsg('" + msg + "')", true);
                            return;
                        }
                    }
                ...
                else
                {
                    if (txtTypeIdentiNo.Text != "")
                    {
                        ...
                        //var check = txtTypeIdentiNo.Text.ToString();
                        if (System.Text.RegularExpressions.Regex.IsMatch(txtTypeIdentiNo.Text, "[^a-zA-Z0-9]"))
                        {
                            dvTINCntry.Attributes.Add("style", "display:none");
                            txtTypeIdentiNo.Text = "";
                            ddlTINCountry.SelectedIndex = 0;
        ...
        protected void btnReloadRelPersCount_Click(object sender, EventArgs e)
        {
            lnkViewRel_Click(this, e);
            if (gvMemDtls.Rows.Count != 0)
            {
                lblRelPersCount.Visible = true;
                lblRelPersCount.InnerText = "No. Of Related Person: " + gvMemDtls.Rows.Count; ;
            }
            else
            {
                lblRelPersCount.Visible = false;
                lblRelPersCount.InnerText = "";
            }
        }

        protected void ddlCountrOfInc_SelectedIndexChanged(object sender, EventArgs e)
        {
            ddlTINCountry.SelectedIndex = 0;
            txtTypeIdentiNo.Text = "";
            dvTINCntry.Attributes.Add("style", "display:none");
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alertmsg", "RemoveLoader('ddlCountrOfIncLoader')", true);
        }
