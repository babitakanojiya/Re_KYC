<%@ Page Title="" Language="C#" MasterPageFile="~/Empty.Master" AutoEventWireup="true" CodeBehind="CKYCControlPrsnView.aspx.cs" Inherits="KMI.FRMWRK.Web.Application.CKYC.CKYCControlPrsnView" %>
                                    ...
                                    <div id="div9" style="display: block;" class="panel-body">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon input-group-addon-tel" style="width: 23% !important; border-top-left-radius: 7% !important; padding: 0px !important; border: 0px !important;">
                                                        <asp:TextBox ID="txtTelOff" runat="server" CssClass="form-control" MaxLength="4" onkeypress="fncInputNumericValuesOnly();" TabIndex="2"></asp:TextBox>
                                                    </span>
                                                    <asp:TextBox ID="txtTelOff2" runat="server" CssClass="form-control" onkeypress="fncInputNumericValuesOnly();"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="input-group">
                                                    ...
                                                    <asp:TextBox ID="txtTelRes2" runat="server" CssClass="form-control" MaxLength="8"
                                        ...
                                        <div class="row" style="margin-top: 4px">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon " style="width: 23% !important; border-top-left-radius: 7% !important; padding: 0px !important; border: 0px !important;">
                                                        <asp:TextBox ID="TextBox21" runat="server" CssClass="form-control" onkeypress="fncInputNumericValuesOnly();"
                                                            MaxLength="2" Style="border-top-left-radius: 4px; border-bottom-left-radius: 4px;" TabIndex="2"></asp:TextBox>
                                                    </span>
                                                    <asp:TextBox ID="TextBox22" runat="server" CssClass="form-control" onkeypress="fncInputNumericValuesOnly();"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon input-group-addon-tel" style="width: 23% !important; border-top-left-radius: 7% !important; padding: 0px !important; border: 0px !important;">
                                                        <asp:TextBox ID="txtFax1" runat="server" onkeypress="fncInputNumericValuesOnly();" MaxLength="4" CssClass="form-control" TabIndex="2"></asp:TextBox>
                                                    </span>
