<%@ Page Title="" Language="C#" MasterPageFile="~/Empty.Master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeBehind="CKYCEntAsRelPerson.aspx.cs" Inherits="KMI.FRMWRK.Web.Application.CKYC.CKYCEntAsRelPerson" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function fnValidateNumber_new(id, No) {
            debugger;
            if (EmptyPagePlaceholder_ddlRelType.selectedIndex != '1') {
                var Mobile1 = document.getElementById(id).value;
                if (Mobile1 != "") {
                    if (parseInt(Mobile1.length) < parseInt(No)) {
                        AlertMsg("Director Identification Number at least " + No + " digit long");
                        document.getElementById(id).value = "";
                        document.getElementById(id).focus();
                        return false;
                    }
...
<asp:Content ID="Content2" ContentPlaceHolderID="EmptyPagePlaceholder" runat="server">
    ...
    <div class="container">
        ...
        <div class="panel panel-success" style="margin-left: 0px; margin-right: 0px; display: none;">
            ...
            <div id="divCKYCdtls" style="display: block;" class="panel-body">
                <div class="row" style="margin-bottom: 5px">
                    ...
                    <div class="col-sm-3" style="text-align: left">
                        <asp:Label ID="lblRefNumber1" Text="" runat="server" Font-Bold="false"></asp:Label>
                        <span style="color: red">*</span>
                    </div>
                    <div class="col-sm-3" style="text-align: left">
                        <asp:TextBox ID="txtRefNumber1" runat="server" MaxLength="14" CssClass="form-control" OnTextChanged="txtRefNumber_TextChanged" AutoPostBack="true" onChange="javascript:this.value=this.value.toUpperCase();"
        ...
        <div class="panel panel-success" style="margin-left: 0px; margin-right: 0px">
            <div id="Div23" runat="server" class="panel-heading" onclick="showHideDiv('divCKYCdtlsRel','btnCKYCdtlsRel');return false;">
                <div class="row">
                    <div class="col-sm-10" style="text-align: left">
                        <span class="glyphicon glyphicon-menu-hamburger"></span>
                    ...
                    <div class="col-sm-2" style="text-align: right">
                        <asp:Label ID="Label1" Text="Version 1.6" runat="server" CssClass="control-label"></asp:Label>
                        <span id="btnCKYCdtlsRel" class="glyphicon glyphicon-collapse-down" style="float: right; padding: 1px 10px ! important; font-size: 18px;"></span>
                    </div>
                </div>
            </div>
            <div id="divCKYCdtlsRel" style="display: block;" class="panel-body">
                <div class="row">
                    <div class="col-sm-3" style="text-align: left">
                ...
                <div class="row" style="margin-top: 4px">
                    ...
                    <div class="col-sm-3">
                        <asp:DropDownList ID="ddlRelType" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlRelType_SelectedIndexChanged" TabIndex="2">
                            <asp:ListItem Value="" Text="Select"></asp:ListItem>
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="row" style="margin-top: 4px">
                    <div id="div24" runat="server" class="col-sm-3" style="text-align: left" visible="false">
                        <asp:Label ID="lblDirector" runat="server" CssClass="control-label"></asp:Label>
                        <span style="color: red">*</span>
                    </div>
                    <div id="div25" runat="server" class="col-sm-3" visible="false">
                        <asp:TextBox CssClass="form-control" runat="server" onblur="fnValidateNumber_new(this.id,'8');"
                            ID="txtDirector" MaxLength="8" TabIndex="2" />
                    </div>
                </div>
            </div>
        </div>

        <div class="container" width="100%" style="display: none">
            <div class="panel panel-success" style="margin-left: 0px; margin-right: 0px; display: none">
                ...
                <div id="divDetailOfEntity" style="display: block;" class="panel-body">
                    ...
                    <div class="row" style="margin-bottom: 5px">
                        ...
                        <div class="col-sm-3" style="text-align: left; top: 0px; left: 0px;">
                            <asp:TextBox ID="txtPanNo" runat="server" MaxLength="10" CssClass="form-control" onChange="javascript:this.value=this.value.toUpperCase();" onblur="validatePAN(this)" Font-Bold="false"
                                TabIndex="2">   <%-- AutoPostBack="true" OnTextChanged="txtPanNo_TextChanged" --%>
                            </asp:TextBox>
                        </div>
                        <div class="col-sm-3" style="text-align: left">
        ...
        <%--Ended by tushar for Personal Detail--%>
        <div class="container" width="100%" style="display: block">
            <div class="panel panel-success" style="margin-left: 0px; margin-right: 0px">
                <div id="Div28" runat="server" class="panel-heading subheader"
                ...
                <div id="divPersonal" style="display: block;" class="form-group panel-body">
                    ...
                    <div class="row">
                        <div class="col-sm-3" style="text-align: left">
                            ...
                            <span style="color: red">*</span>
                            <asp:CheckBox ID="ChkUpdName" runat="server" CssClass="standardcheckbox" Text="" Enabled="false"
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="col-sm-6" style="padding: 0">
                                <asp:RadioButtonList ID="rbtFS" runat="server" CssClass="radiobtn" ClientIDMode="Static" RepeatDirection="Horizontal"
                                    Visible="true" TabIndex="14" AutoPostBack="false">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                <asp:TextBox ID="txtDOB" runat="server" CssClass="form-control" placeholder="dd-mm-yyyy" 
                                    onchange="ValidateDOB(this.value);" MaxLength="10" TabIndex="2"></asp:TextBox>
                                <div class="input-group-btn">
                                    <div class="btn btn-primary btn-lg-kmi" onclick="callCalender()">
                                        <span class="glyphicon glyphicon-calendar BtnGlyphicon"></span>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-3" style="text-align: left">
                            <asp:Label ID="Label4" Text="PAN" runat="server" CssClass="control-label">
                            </asp:Label>
                            <span style="color: red">*</span>
                        </div>
                        <div class="col-sm-3" style="text-align: left">
                            <asp:TextBox runat="server" ID="TextBox1" CssClass="form-control" OnTextChanged="TextBox1_TextChanged"
                                onblur="return validatePAN(this)" AutoPostBack="true" onkeyup="javascript: this.value = this.value.toUpperCase()"
                                TabIndex="29" />
                        </div>
                        <div class="col-sm-3">
                    ...
                    <div class="row">
                        <div class="col-sm-3" style="text-align: left">
                            <asp:Label ID="lblIsoCountryCodeOthr" Text="Nationality" Visible="true"
                                runat="server" CssClass="control-label"></asp:Label>
                    ...
                    <ContentTemplate>
                        <div class="row" style="margin-bottom: 5px">
                            ...
                            <div class="col-sm-3">
                                <%--<asp:UpdatePanel runat="server">
                                    <ContentTemplate>--%>
                                <asp:DropDownList ID="ddlCertifiecopy" runat="server" CssClass="form-control" TabIndex="2" AutoPostBack="true"
                                    OnSelectedIndexChanged="ddlCertifiecopy_SelectedIndexChanged">
                            ...
                            <div id="divIdProof" runat="server">
                                ...
                                <div id="divPassNotxt" runat="server" class="col-sm-3">
                                    <asp:TextBox ID="txtPassNo" runat="server" MaxLength="50" TabIndex="2"
                                        CssClass="form-control" Font-Bold="false" onChange="javascript:this.value=this.value.toUpperCase();">
                                    </asp:TextBox>
                                    <%--onkeypress="funIsAlphaNumericHypenWithoutSpace()" AutoPostBack="true" OnTextChanged="txtPassNo_TextChanged" --%>
                                </div>
                            </div>
                            <%--</ContentTemplate>
                                </asp:UpdatePanel>--%>
                            ...
                            <div class="row" style="margin-top: 4px">
                                ...
                                <div class="col-sm-3">
                                    <asp:DropDownList ID="ddlProofOfAddress1" runat="server" CssClass="form-control"
                                        TabIndex="2">
                                        <%--OnSelectedIndexChanged="ddlProofOfAddress1_SelectedIndexChanged"--%>
                                        <asp:ListItem Value="" Text="Select"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <div id="divAddProof1" runat="server" class="row" visible="false" style="margin-top: 4px">
                                <div id="div26" runat="server" class="col-sm-3" style="text-align: left">
                                    <asp:Label ID="lblPassportNoAdd1" Placeholder="Passport Number" runat="server" CssClass="control-label"></asp:Label>
                                    <span style="color: red">*</span>
                                </div>
                                <div id="div27" runat="server" class="col-sm-3">
                                    <asp:TextBox CssClass="form-control" runat="server"
                                        ID="txtPassNoAdd1" MaxLength="15" />
                                </div>
                            ...
                            <div class="row" style="margin-top: 4px">
                                ...
                                <div class="col-sm-3">
                                    <div id="dvState1" runat="server" class="input-group">
                                        <asp:DropDownList ID="ddlState1" runat="server" CssClass="form-control" Enabled="true" TabIndex="2">
                                            <asp:ListItem Value="" Text="Select"></asp:ListItem>
                                        </asp:DropDownList>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    ...
                                    <asp:TextBox ID="txtTelOff2" runat="server" CssClass="form-control" onkeypress="fncInputNumericValuesOnly();" TabIndex="2"
                                        onblur="fnValidateNumber(this.id,'8');" MaxLength="10"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-sm-3" style="text-align: left">
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    ...
                                    <asp:TextBox ID="txtTelRes2" runat="server" CssClass="form-control" MaxLength="10" onblur="fnValidateNumber(this.id,'8');"
                        ...
                        <div class="row" style="margin-top: 4px">
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    ...
                                    <asp:TextBox ID="txtMobile2" runat="server" CssClass="form-control" onkeypress="fncInputNumericValuesOnly()" TabIndex="2" onblur="validateMobileNumber(this);"
                ...
                <div class="panel panel-success" style="margin-left: 0px; margin-right: 0px">
                    ...
                    <div id="div21" style="display: block;" class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3" style="text-align: left; top: 0px; left: 0px; display: none">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <asp:TextBox CssClass="form-control" runat="server" ID="txtInsCode" MaxLength="50" onkeypress="funIsAlphaNumericWithoutSpace();"
                                    Enabled="true" TabIndex="2" />
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header" style="text-align: center; background-color: #dff0d8;">
                    ...
                    <asp:Label ID="Label5" Text="Confirmation" runat="server" Font-Bold="true"></asp:Label>
                </div>
