<%@ Page Title="" Language="C#" MasterPageFile="~/Empty.Master" AutoEventWireup="true" CodeBehind="CKYCRltdPrsnQC.aspx.cs" Inherits="KMI.FRMWRK.Web.Application.CKYC.CKYCRltdPrsnQC" %>
    ...
    <div class="container" style="margin-top: 0px; width: 100%;">
            ...
            <div id="Div18" runat="server" class="panel-heading" onclick="showHideDiv('divCKYCdtls','btnCKYCdtls');return false;">
                <div class="row">
                    <div class="col-sm-10" style="text-align: left">
                        ...
                        <asp:Label ID="Label6" Text="Relationship Details" runat="server" CssClass="control-label">
                        </asp:Label>
                    </div>
                                    ...
                                    <div id="divPersonal" style="display: block;" class="form-group panel-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9" style="padding: 0">
                                                ...
                                                <div class="col-sm-10" style="padding: 0">
                                                    <div class="col-sm-4" style="padding-left: 0">
                                                        <asp:TextBox ID="txtGivenName1" runat="server" Enabled="false" CssClass="form-control" onchange="javascript:this.value=this.value.toUpperCase();" onkeypress="funIsAlphaNumericWithSpace();"
                                                            MaxLength="50" TabIndex="11" onblur="CheckSpaces();return false;" placeholder="First Name">
                                                        </asp:TextBox>
                                                    </div>
                                                    <div class="col-sm-4" style="padding-left: 0">
                                                        <asp:TextBox ID="txtMiddleName1" runat="server" Enabled="false" CssClass="form-control" onchange="javascript:this.value=this.value.toUpperCase();" onkeypress="funIsAlphaNumericWithSpace();"
                                                            MaxLength="50" TabIndex="12" onblur="CheckSpaces();return false;" placeholder="Middle Name">
                                                        </asp:TextBox>
                                                    </div>
                                                    <div class="col-sm-4" style="padding-left: 0">
                                                        <asp:TextBox ID="txtLastName1" runat="server" Enabled="false" CssClass="form-control" onchange="javascript:this.value=this.value.toUpperCase();" onkeypress="funIsAlphaNumericWithSpace();"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9" style="padding: 0">
                                                ...
                                                <div class="col-sm-10" style="padding: 0">
                                                    <div class="col-sm-4" style="padding-left: 0">
                                                        <asp:TextBox ID="txtGivenName2" runat="server" Enabled="false" CssClass="form-control" onchange="javascript:this.value=this.value.toUpperCase();" onkeypress="funIsAlphaNumericWithSpace();"
                                                            MaxLength="50" TabIndex="16" onblur="CheckSpaces();return false;" placeholder="First Name">
                                                        </asp:TextBox>
                                                    </div>
                                                    <div class="col-sm-4" style="padding-left: 0">
                                                        <asp:TextBox ID="txtMiddleName2" runat="server" Enabled="false" CssClass="form-control" onchange="javascript:this.value=this.value.toUpperCase();" onkeypress="funIsAlphaNumericWithSpace();"
                                                            MaxLength="50" TabIndex="17" onblur="CheckSpaces();return false;" placeholder="Middle Name">
                                                        </asp:TextBox>
                                                    </div>
                                                    <div class="col-sm-4" style="padding-left: 0">
                                                        <asp:TextBox ID="txtLastName2" runat="server" Enabled="false" CssClass="form-control" onchange="javascript:this.value=this.value.toUpperCase();" onkeypress="funIsAlphaNumericWithSpace();"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9" style="padding: 0">
                                                ...
                                                <div class="col-sm-10" style="padding: 0">
                                                    <div class="col-sm-4" style="padding-left: 0">
                                                        <asp:TextBox ID="txtGivenName3" runat="server" Enabled="false" CssClass="form-control" onchange="javascript:this.value=this.value.toUpperCase();" onkeypress="funIsAlphaNumericWithSpace();"
                                                            MaxLength="50" TabIndex="20" onblur="CheckSpaces();return false;" placeholder="First Name">
                                                        </asp:TextBox>
                                                    </div>
                                                    <div class="col-sm-4" style="padding-left: 0">
                                                        <asp:TextBox ID="txtMiddleName3" runat="server" Enabled="false" CssClass="form-control" onchange="javascript:this.value=this.value.toUpperCase();" onkeypress="funIsAlphaNumericWithSpace();"
                                                            MaxLength="50" TabIndex="21" onblur="CheckSpaces();return false;" placeholder="Middle Name">
                                                        </asp:TextBox>
                                                    </div>
                                                    <div class="col-sm-4" style="padding-left: 0">
                                                        <asp:TextBox ID="txtLastName3" runat="server" Enabled="false" CssClass="form-control" onchange="javascript:this.value=this.value.toUpperCase();" onkeypress="funIsAlphaNumericWithSpace();"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3">
                                                <asp:TextBox CssClass="form-control"
                                                    ...
                                                    runat="server" ID="txtDOB" MaxLength="15" Enabled="false"
                                                    TabIndex="23" />
                                    ...
                                    <div id="div3" style="display: block;" class="panel-body">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12" style="text-align: left">
                                                <asp:CheckBox ID="chkTick" Enabled="false" Text="RESIDENCE FOR TAX PURPOSES IN JURISDICTION(S) OUTSIDE INDIA" AutoPostBack="true"
                                                    CssClass="standardcheckbox" runat="server" TabIndex="31" /><%--OnCheckedChanged="chkTick_Checked"--%>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-3" style="text-align: left">
                        ...
                        <div id="divIdProof" runat="server" class="row">
                            ...
                            <div id="divPassDate" runat="server" class="col-sm-3">
                                ...
                                <asp:TextBox CssClass="form-control" onmousedown="$('#EmptyPagePlaceholder_txtPassExpDate').datepicker({ changeMonth: true, changeYear: true, dateFormat: 'dd/mm/yy' });"
                                    runat="server" ID="txtPassExpDate" Enabled="false" MaxLength="15" TabIndex="38" />
                            ...
                            <ContentTemplate>
                             ...
                             tabindex="1" />--%>
                                    ...
                                    <div id="div7" style="display: block;" class="panel-body">
                                        <div class="row">
                                            <div class="col-sm-12" style="text-align: left">
                                                <asp:CheckBox ID="chkPerAddress" Text="CURRENT / PERMANENT / OVERSEAS ADDRESS DETAILS" Enabled="false" AutoPostBack="true"
                                                    runat="server" CssClass="control-label" TabIndex="40" /><%--OnCheckedChanged="chkPerAddress_Checked"--%>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-3" style="text-align: left">
                                        ...
                                        <div id="divAddProof" runat="server" class="row">
                                            ...
                                            <div id="divPassDateAdd" runat="server" class="col-sm-3">
                                                ...
                                                <asp:TextBox CssClass="form-control" onmousedown="$('#EmptyPagePlaceholder_txtPassExpDateAdd').datepicker({ changeMonth: true, changeYear: true, dateFormat: 'dd/mm/yy' });"
                                                    runat="server" Enabled="false" ID="txtPassExpDateAdd" MaxLength="15" TabIndex="44" />
                    ...
                    <div id="menu6" style="display: block;" class="panel-body">
                        ...
                        <div class="panel panel-success" style="margin-left: 0px; margin-right: 0px">
                            ...
                            <div id="div15" style="display: block;" class="panel-body">
                                <div class="row">
                                    <div class="col-sm-12" style="text-align: left; display: flex;">
                                        <asp:CheckBox Style="margin-bottom: -0.5%;" Enabled="false" ID="chkAppDeclare1" Text="I/We hereby declare that the details furnished above are true and correct to the best of my/our knowledge and belief and I/we undertake to inform you of "
                        ...
                        <div class="panel panel-success" style="margin-left: 0px; margin-right: 0px">
                            ...
                            <div id="div17" style="display: block;" class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3" style="text-align: left; top: 0px; left: 0px;">
                                        <asp:TextBox ID="txtDate3" Enabled="false" runat="server" CssClass="form-control" MaxLength="10"></asp:TextBox><%--TextMode="Date"--%>
                                    </div>
        ...
        <%-- <div class="row" style="margin-top: 12px;">
            <div class="col-sm-12" align="center">
                  <asp:LinkButton ID="btnCancel" lnkViewRelCssClass="btn-animated bg-horrible" runat="server" OnClick="btnCancel_Click" TabIndex="110">
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <asp:LinkButton ID="btnNoConfirmYesNo" type="button" class="btn-animated bg-horrible" runat="server"><span class="glyphicon glyphicon-remove BtnGlyphicon"></span> No</asp:LinkButton><%--OnClick="ConfirmNo"--%>
                </div>
            </div>
        </div>
    </div>
