    ...
    <center>
       <asp:ScriptManager ID="SM1" runat="server">
        ...
        <div id="menu1" style="display:block;" runat="server" class="panel-body">
          <div class="panel panel-success"f style="margin-left:0px;margin-right:0px">
        ...
        <div class="col-sm-10" style="text-align:left">
        <span class="glyphicon glyphicon-menu-hamburger"></span>
        <asp:Label ID="Label10" Text="PROOF OF IDENTITY" runat="server"  CssClass="control-label" ></asp:Label>
