...
namespace KMI.FRMWRK.Web.Application.CKYC
{
    public partial class Search : System.Web.UI.Page
    {
        ...
        {
            // ScriptManager.RegisterStartupScript(this, this.GetType(), "onclick", "ShowProgressBar_New('Searching..Please wait');", true);
            //ScriptManager.RegisterStartupSc ript(this, this.GetType(), "onclick", "  HideProgressBar();", true);
            ...
            // ScriptManager.RegisterStartupScript(this, this.GetType(), Guid.NewGuid().ToString(), " MstShowHide('divRegSub', 'none');", true);
            if (IsPostBack)
            {
                SetActiveMenu(hdnCurrActId.Value);
                //SetActiveCustJourney(hdnQCAppro.Value);
                //ScriptManager.RegisterStartupScript(this, this.GetType(), Guid.NewGuid().ToString(), "PageLoad('');", true);
                // ScriptManager.RegisterStartupScript(this, this.GetType(), Guid.NewGuid().ToString(), " MstShowHide('divRegSub', 'block');", true);
            }
        ...
        public void SetActiveMenu(string Flag)
        {
            if (Flag == "REG")
            {
                Imgregistration.Src = "../../assets/images/WorkbenchIcons/registration_hover_btn.png";
            }
            ...
            try
            {
                ...
                if (objDt.Rows.Count != 0)
                {
                    ...
                    for (int i = 0; i < objDt.Rows.Count; i++)
                    {
                        ...
                        htmlTable.Append("<div style='text-align:center'");
                        //Default IMG
                        htmlTable.Append(" < img id=" + FiRefNo + "  src = 'ImageCSharp.aspx?ImageID=" + ImgURL + "' style = 'width: 133px; height: 123px; padding-left: 0px;' >");
                        ...
                        //else
                        //{
                        htmlTable.Append("style = 'width: 133px; height: 123px;'");
                        //}
                ...
                else
                {
                    ...
                    htmlTable.Append("<span style='padding: 0px 530px 0px 540px; color: black; font - size: 15px;' >No Record Found</span>");
