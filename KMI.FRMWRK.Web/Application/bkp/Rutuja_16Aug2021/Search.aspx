...
<asp:Content ID="Content2" ContentPlaceHolderID="EmptyPagePlaceholder" runat="server">
    ...
    <script type="text/javascript">
        function LoadCtrl(flag) {
            ...
            document.getElementById("EmptyPagePlaceholder_btnSrch").click();
        }
        function ClrCtrl(flag) {
            debugger;
           <%-- document.getElementById("<%= divVal.ClientID %>").style.display = flag;
            document.getElementById("<%= divValTyp.ClientID %>").style.display = flag;
            document.getElementById("<%= ddlSrchTyp.ClientID %>").Value = "";
        ...
        function LoadQCPage(Flag, refno, Regno, CndStatus, batchid) {
            ...
            // var ctrl = document.getElementById(id);  View Details
            if (true) {
                ...
                if (Flag == "ERR") {
                    ...
                    //below started by Rutuja on 22Mar for Alert Showing

                }
                else if (Flag == "ZIP") {
                    // ShowDivProgressBar('Please wait ZIP File Generating...')
                    ...
                    ShowDivProgressBar('Please wait Processing Data...')
                    ...
                    ShowDivProgressBar('Sending Download Request...')
                    //document.getElementById(refno).style.display = "none";
                    document.getElementById("EmptyPagePlaceholder_btnZipFileGeneration").click();
                    setTimeout(function () {
                        HideProgressBar();
                    ...
                    //ended by Rutuja on 22Mar for Alert Showing.
                    ...
                    $('#myModalRaise').modal();
                    //document.getElementById("EmptyPagePlaceholder_divRegSub").style.display = "block";
                    ...
                    //document.getElementById("EmptyPagePlaceholder_btnUpdAfterProcessOnWrkBench").click();
                }                 //added by Rutuja on 22Mar for Alert Showing
            ...
            if (Flag == "Download") {
                ...
                //window.open("CKYCQC.aspx?RefNo=" + '10000251' + "&Status=QC", '', 'width=640,height=354,toolbar=no,scrollbars=yes,resizable=yes,left=300,top=230,location=0;');
                var modal = document.getElementById('myModalRaise');
            ...
            //if (Flag == "UpdateDetails") {
            //    ShowProgressBar('Sending Update Request...');
            //    document.getElementById(refno).style.display = "none";
            //    setTimeout(function () { HideProgressBar(); }, 3000);
            //}
            //if (Flag == "SearchDetails") {
            //    ShowProgressBar('Sending Search Request...');
            //    document.getElementById(refno).style.display = "none";
            //    setTimeout(function () { HideProgressBar(); }, 3000);
    ...
    <script type="text/javascript">
        ...
        function ChangeImg(divID, FID, ImgUrl) {
            ...
            setTimeout(function () { HideProgressBar(); }, 3000);
            //if (divID == "Img9001156") {
            //    //document.getElementById(divID).src = "../../assets/images/CompanyLogo/NQA_logo.jpg";
            //    document.getElementById(FID).style.display = "block";

            //}
            //document.getElementById(divID).DataImageUrlFormatString = ImgUrl;
            //document.getElementById(divID).src = 'data:image/jpeg;base64,' + btoa(ImgUrl);
            //document.getElementById(divID).src = 'data:image/jpeg;base64,' + hexToBase64(ImgUrl);
            if (ImgUrl != "") {
        ...
        //added by kalpak for increasing dynamic dropdowns width when text is long
    ...
    <script type="text/javascript">
        ...
        //$("#EmptyPagePlaceholder_btnSearch").click(function () {
        //    $("#coverScreen").show();
        //});
        ...
        function ShowProgressBar(Msg) {
            debugger;
            var Msg = Msg
            //document.getElementById('dvProgressBar').style.visibility = "visible"; trSearchDetails
            // document.getElementById("EmptyPagePlaceholder_imgStatus").style.display = "block";
            //document.getElementById("EmptyPagePlaceholder_imgStatus").src = "assets/images/dashboard-icon/Loader.gif";    Loading. Please wait.
            ...
            //setTimeout(function () { HideProgressBar(); }, 10000);
        }
        ...
        function EnableSearchSegment() {
            ...
            //document.getElementById("EmptyPagePlaceholder_trDgViewDtl").style.display = "none";
        }
    ...
    <script type="text/javascript">
        ...
        function Start(divID) {
            ...
            //$("#divCls").animate({ left: '86%' });
            //$("#divUnsolicited").animate({ left: '71%' });
            //$("#divUpdDoc").animate({ left: '56%' });
            //$("#divDownload").animate({ left: '41%' });
            //$("#divSearch").animate({ left: '26%' });
            //$("#divRegis").animate({ left: '11%' });
            //$("#divStart").animate({ left: '5%' });
        ...
        function PageLoad(divID) {
            ...
            //document.getElementById(divRegSub).style.display = "block";
        ...
        function SetActive(NxtActID) {
            ...
            //document.getElementById("EmptyPagePlaceholder_btnTopMenu").click();
            Search();
            if (NxtActID = "REG") {
    ...
    <style type="text/css">
        ...
        .divRegis {
            background-image: url(../../assets/images/WorkbenchIcons/registration_btn.png);
        }
    </style>
    ...
    <asp:UpdatePanel runat="server">
        <ContentTemplate>
            <div class="col-sm-12" style="padding: 0 70px 20px 70px;">
                ...
                <span style="padding-left: 5px; margin: 0px;">An unified workbench to view, process and monitor all cases for search, download, registration,update and unsolicited update notifications. Each case is loaded in the middleware anvil and is processed through the dynamic workflow stages till completion.   
                </span>
            </div>
            <%--Added By Shubham--%>
                ...
                <ContentTemplate>
                    <div class="row" style="margin-bottom: 111px;">
                        <div class="col-sm-12" style="width: 100%!important;">
                            <div id="divCls" class="col-sm-1 DivComm" style="left: 85%; width: 101px; display: block;">
                                Close
                        <img src="../../Image/08_End.png" />
                            </div>
                            <div id="divUnsolicited" class="col-sm-2 DivComm" style="left: 70%; display: block;" onclick="ShowDivProgressBar('Loading..Please wait');">
                                <img id="ImgUnSolicited" runat="server" src="../../assets/images/WorkbenchIcons/unsolicited_update_btn.png" onclick="SetActive('ULS');" />
                            </div>
                            <div id="divUpdDoc" class="col-sm-2 DivComm" style="left: 55.5%; display: block;" onclick="ShowDivProgressBar('Loading..Please wait');">
                            ...
                            <div id="divSearch" class="col-sm-2 DivComm" style="left: 26.5%; display: block;" onclick="ShowDivProgressBar('Loading..Please wait');">
                                <img id="Imgsearch" runat="server" src="../../assets/images/WorkbenchIcons/search_btn.png" onclick=" SetActive('SRCH');" />
                            </div>
                            <div id="divRegis" class="col-sm-2 DivComm" style="left: 12%; display: block;" onclick="Search();ShowDivProgressBar('Loading..Please wait');">
                                <img id="Imgregistration" runat="server" src="../../assets/images/WorkbenchIcons/registration_btn.png" onclick="SetActive('REG');" />
                            </div>
                            <div id="divStart" class="col-sm-1 DivComm" style="left: 6%; width: 101px;" onclick="Start('EmptyPagePlaceholder_iFrameLoadPage');MstShowHide('divImg', 'none');">START<img src="../../Image/01_Strat_icon.png" /></div>
            ...
            <div class="panel  panel-success" id="divSearchSegment" style="margin-left: 2%; margin-right: 2%; margin-top: 0.5%; display: none;">
                ...
                <div>
                    <div class="row">
                        <%-- <asp:Image ID="Strip" runat="server" ImageUrl="~/Images/Cust_journey_imag.jpg" />--%>
                        <%--<div class="col-sm-10" style="text-align: left">
                            <span class="glyphicon glyphicon-menu-hamburger"></span>
                            <asp:Label ID="lblTitle" runat="server" Font-Bold="False" Text="SEARCH"></asp:Label>
                        </div>--%>
                        <%--<div class="col-sm-2">
                    ...
                    <div id="divSrvcReqReport1" style="display: block;" class="panel-body panel-collapse collapse in">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12" style='margin-top: 15px;'>
                                <%--<asp:Button ID="btnSearch" Text="Search" OnClick="btnSearch_Click" OnClientClick="ShowProgressBar('Searching..Please wait');" CssClass="btn-animated bg-green" runat="server"> --%>  <%--OnClientClick="return validtab();"--%>
                ...
                <div class="panel panel-success" style='margin-right: 60px; margin-left: 60px; border: 1px solid #00b4bf;'>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="col-sm-3">
                                <asp:LinkButton ID="btnClr" TabIndex="43" runat="server"  OnClick="btnClr_Click">
                                    <span class="glyphicon glyphicon-remove" style="float: right; font-size: 20px; line-height: 2; color: #00b4bf;"> </span>
                                </asp:LinkButton>
                                <%--<span class="glyphicon glyphicon-remove" onclick="ClrCtrl('none');" style="float: right; font-size: 20px; line-height: 2; color: #00b4bf;"></span>--%>
                                <span class="glyphicon glyphicon-search" onclick="LoadCtrl('block');" style="float: right; font-size: 20px; line-height: 2; color: #00b4bf;"></span>
            ...
            <div class="modal" id="myModalRaise" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="padding-top: 0px;">
                <div class="modal-dialog" style="padding-top: 0px; margin: 10px;">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <iframe id="iframeCFR" src="" width="100%" height="470" frameborder="0" allowtransparency="true"></iframe>
                        </div>
       ...
       <asp:Label ID="lblMsg" Text="" runat="server" > </asp:Label>
            ...
            <div id="divImg" class="panel  panel-success" style="margin-left: 2%; margin-right: 2%; margin-top: 130px">
                ...
                <div class="panel-body" style="text-align: center;">
                    <img src="../../assets/images/Anvil_BG.jpg" />
                </div>
            </div>
