...
<asp:Content ID="Content2" ContentPlaceHolderID="EmptyPagePlaceholder" runat="server">
    ...
    <div class="container" style="margin-top: 0px; width: 100%;">
        ...
        <div class="panel panel-success">
            ...
            <div class="panel panel-success">
                    <div id="Div8" class="panel-heading" onclick="showHideDiv('div9','Span3');return false;">
                        <div class="row">
                            <div class="col-sm-10" style="text-align: left">
                                <span class="glyphicon glyphicon-menu-hamburger"></span>
        ...
        <asp:UpdatePanel ID="ddd" runat="server">
            <ContentTemplate>
                <div class="panel panel-success">
                    <div id="div13" class="panel-heading" onclick="showHideDiv('divPhoto','btnImage');return false;">
                        <div class="row">
                            <div class="col-sm-10" style="text-align: left">
                                <span class="glyphicon glyphicon-menu-hamburger"></span>
