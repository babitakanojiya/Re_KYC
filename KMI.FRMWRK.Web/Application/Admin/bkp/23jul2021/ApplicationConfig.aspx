...
<asp:Content ID="Content2" ContentPlaceHolderID="EmptyPagePlaceholder" runat="server">
    ...
    <script type="text/javascript">
        function LoadAPI()
        { window.open("http://kmidev.centralus.cloudapp.azure.com/CkycWebApi/Help"); }
    ...
    <asp:UpdatePanel runat="server">
        <ContentTemplate>
                        ...
                        <div class="row" style="margin: 0px">
                            ...
                            <div class="col-sm-2">
                                <span id="ReqDtlsInfoIcon" class="glyphicon glyphicon-question-sign" onmouseover="NotificationDivSlide('DivSrcReqDtlsNote','ReqDtlsInfoIcon');
                                    ...
                                    style="float: left; padding: 3px 10px ! important; font-size: 18px; color: red; margin-left: 102px;"></span>
          ...
          <span id="IntlCnfgDtls" style="text-align: justify; font-size: 11px;"></span>
                    ...
                    <br />
                    <div class="panel-heading" onclick="showHideDiv('divOfficeandUSer','btnToggleNew2');return false;">
                        <div class="row" style="margin: 0px">
                            <div class="col-sm-10" style="text-align: left; margin-bottom: -7px;">
                                <img src="../../Image/add_customer_icon.png" style="width: 35px" />
                                <%--<span class="glyphicon glyphicon-menu-hamburger"></span>--%>
                    ...
                    <div class="panel-body" id="divOfficeandUSer">
