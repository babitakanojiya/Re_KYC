<%@ Page Title="" Language="C#" MasterPageFile="~/Empty.Master" AutoEventWireup="true" CodeBehind="CRS_VER_HST.aspx.cs" Inherits="KMI.FRMWRK.Web.Application.Admin.CRS_VER_HST" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="EmptyPagePlaceholder" runat="server">
    ...
    <script type="text/javascript">
        ...
        function fnindlglTabs(strindlglTabs) {
            debugger;
            document.getElementById('EmptyPagePlaceholder_hdntimeflag').value = "";
            document.getElementById('EmptyPagePlaceholder_hdnsubflag').value = "";
        ...
        function fnsetsubmenu(submenu) {
            debugger
            document.getElementById('EmptyPagePlaceholder_hdnsubflag').value = submenu;
                       ...
                       <div class="panel-heading" onclick="ShowReqDtl('EmptyPagePlaceholder_divfinhdr','btnToggleNew');return false;">
                        <div class="row" style="margin: 0px">
                            <div class="col-sm-10" style="text-align: left">
                                <asp:Label ID="Label1" runat="server" Font-Bold="true" Font-Size="18px" Text="CERSAI Version History"></asp:Label>
                            </div>
                            </div> 
      ...
      <asp:Button ID="BTNLEGLINTAB" runat="server" Style="display: none" Text="Button" OnClick="BTNLEGLINTAB_Click"/>
                ...
                <asp:UpdatePanel ID="UpdatePanelgrd" runat="server">
                    <ContentTemplate>
                        ...
                        BackColor="White"  BorderStyle="None" BorderWidth="0px" CellPadding="4" ForeColor="Black"  PageSize="10" 
                            GridLines="Horizontal" OnPageIndexChanging="grdhst_PageIndexChanging">
                            ...
                            <HeaderStyle CssClass="gridview th HeaderText" BackColor="#333333" Font-Bold="True" ForeColor="White" />
                             <EmptyDataTemplate>
                            ...
                            <Columns>
                               ...
                               <%-- <asp:TemplateField HeaderText="Module Name"  SortExpression="ModuleName" ItemStyle-CssClass="text-center"  HeaderStyle-ForeColor
                                ...
                                <asp:TemplateField HeaderText="Seq No"  SortExpression="SeqNo"  ItemStyle-CssClass="AlignCenter HeaderText"  HeaderStyle-ForeColor="White">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Classificatin Type"  ItemStyle-CssClass="AlignCenter"  HeaderStyle-ForeColor
                                      ="White">
                                    <ItemTemplate>
                                        <asp:Label ID="lblrmk"  runat="server" Text='<%# Bind("ClassificationType")%>'></asp:Label>
                                        </ItemTemplate>                                                                    
                                    <HeaderStyle ForeColor="White" />
                                  
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Remark" ItemStyle-CssClass="AlignCenter"  HeaderStyle-ForeColor
                                      ="White">
                                    <ItemTemplate>
                                 ...
                                 <asp:TemplateField HeaderText="Revised By" ItemStyle-CssClass="AlignCenter"  HeaderStyle-ForeColor
                                      ="White">
                                    <ItemTemplate>
                                 ...
                                 <asp:TemplateField HeaderText="Revised DateTime"  SortExpression="CreatedDTim" ItemStyle-CssClass="AlignCenter"  HeaderStyle-ForeColor
                                      ="White">
                                    <ItemTemplate>
                                        <asp:Label ID="lbldt"  runat="server" Text='<%# Eval("CreatedDTim","{0:dd/MM/yyyy}")%>'></asp:Label>
                                        </ItemTemplate>                                                                    
                                     <HeaderStyle ForeColor="White" />
                                    
                                </asp:TemplateField>
                                 <asp:TemplateField HeaderText="Effective Date"  SortExpression="Effectivedatetime" ItemStyle-CssClass="AlignCenter"  HeaderStyle-ForeColor="White">
                                    <ItemTemplate>
                                        <asp:Label ID="lblEffdt"  runat="server" Text='<%# Eval("Effectivedatetime","{0:dd/MM/yyyy}")%>'></asp:Label>
                                        </ItemTemplate>                                                                    
                                     <HeaderStyle ForeColor="White" />
